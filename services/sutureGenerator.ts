...
"${script}"
**影片案例隔离:** 如果剧本协议头含有“影片案例”，它只是前一阶段的场面机制元数据。不得把片例名称、原片角色、原片道具、原片色彩、原片时代、原片音乐或 IP 标志写入 visualDesc / visualAction / sound。
...
5.  **影片案例防污染 (关键):**
    *   只能读取镜头块中的 **画面、环境、光影、声音、音轨内容**。
    *   不得把协议头里的影片案例当作图像风格、色彩方案、材质、镜头媒介或资产外观。
