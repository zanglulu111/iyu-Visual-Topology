...
import { X, Aperture, BookOpen, Layers, List, Compass, ChevronRight, HelpCircle, History as HistoryIcon, Settings, Languages, User as UserIcon, Moon, Sun, Search } from 'lucide-react';
