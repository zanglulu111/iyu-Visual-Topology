    ...
    return (
        <div className="w-full max-w-[1920px] mx-auto py-4 px-2 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
                ...
                border min-h-[300px]
                ${active
                    ? `${borderClass} shadow-[0_45px_100px_rgba(0,0,0,0.1)] -translate-y-1 ${isRetro ? 'bg-[#FDFCF8]' : 'bg-zinc-950'} backdrop-blur-none`
                    : `border-transparent shadow-none bg-white/[0.01] backdrop-blur-2xl`
                }
              `}
                        >
