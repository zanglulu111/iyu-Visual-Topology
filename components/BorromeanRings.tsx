...
export const BorromeanRings: React.FC<BorromeanRingsProps> = ({
    ...
    const ringHex = isHomepage ? {
        ...
        real: isRetro ? '#A3483E' : (useNarrativeAccent ? '#FF4F3F' : driverType === DriverType.COMMERCIAL ? '#06B6D4' : driverType === DriverType.EXPERIMENTAL ? '#D946EF' : driverType === DriverType.AESTHETIC ? '#8B5CF6' : driverType === DriverType.TRAILER ? '#F97316' : driverType === DriverType.SUTURE ? '#22D3EE' : '#F59E0B'),
        symbolic: isRetro ? '#9C824A' : (useNarrativeAccent ? '#FF8175' : driverType === DriverType.COMMERCIAL ? '#22D3EE' : driverType === DriverType.EXPERIMENTAL ? '#F0ABFC' : driverType === DriverType.AESTHETIC ? '#A78BFA' : driverType === DriverType.TRAILER ? '#FB923C' : driverType === DriverType.SUTURE ? '#67E8F9' : '#06B6D4'),
        imaginary: isRetro ? '#6A7D6A' : (useNarrativeAccent ? '#D63D32' : driverType === DriverType.COMMERCIAL ? '#0891B2' : driverType === DriverType.EXPERIMENTAL ? '#A21CAF' : driverType === DriverType.AESTHETIC ? '#6D28D9' : driverType === DriverType.TRAILER ? '#EA580C' : driverType === DriverType.SUTURE ? '#0E7490' : '#F43F5E'),
        sinthome: isRetro ? '#506678' : (useNarrativeAccent ? '#8B1E17' : driverType === DriverType.COMMERCIAL ? '#0E7490' : driverType === DriverType.EXPERIMENTAL ? '#86198F' : driverType === DriverType.AESTHETIC ? '#4C1D95' : driverType === DriverType.TRAILER ? '#C2410C' : driverType === DriverType.SUTURE ? '#06B6D4' : '#10B981'),
    } : {
