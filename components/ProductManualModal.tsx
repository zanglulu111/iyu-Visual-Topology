        ...
        <>
            {parts.map((part, i) => {
                if (part.startsWith('**') && part.endsWith('**')) {
                    return (
                        <span key={i} className={`${themeClass} bg-white/5 px-1 rounded`}>
                            {part.slice(2, -2)}
                        </span>
                    );
                }
                            ...
                            {category.concepts.map((concept: LacanConcept) => (
                                ...
                                >
                                    <div className="mb-auto">
                                        <h4 className={`text-lg font-semibold text-zinc-200 ${theme.groupHoverText} transition-colors leading-tight mb-2`}>
                                            {concept.name}
                                        </h4>
                                ...
                                <div className="grid grid-cols-1 gap-12">
                                    <div className="bg-zinc-900/30 border border-zinc-800 rounded-2xl p-10 space-y-4 shadow-xl">
                                        <div className={`flex items-center gap-3 ${theme.text} border-b border-zinc-800 pb-6 mb-6`}>
                                            ...
                                            <h4 className="text-base font-bold uppercase tracking-widest">哲学原理深度解析 (Philosophical Depth)</h4>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-12">
                                        ...
                                        <div className="bg-zinc-900/30 border border-zinc-800 rounded-2xl p-10 space-y-4 shadow-xl">
                                            <div className="flex items-center gap-3 text-purple-400 border-b border-zinc-800 pb-6 mb-6">
                                                <Cpu size={24} />
                                                <h4 className="text-base font-bold uppercase tracking-widest">引擎应用 (Engine Mechanics)</h4>
                                            </div>
