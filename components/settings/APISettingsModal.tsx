            ...
            <div className={`w-[800px] max-h-[90vh] ${theme === 'retro' ? 'bg-[#F9F7F1]' : 'bg-[#0c0c0c]'} border ${theme === 'retro' ? 'border-[#8B261D]' : 'border-zinc-800'} rounded-xl shadow-2xl flex flex-col overflow-hidden`}>
                ...
                <div className={`flex items-center justify-between px-8 py-6 border-b ${theme === 'retro' ? 'border-[#8B261D]/20 bg-[#F4EFE0]' : 'border-zinc-800'}`}>
                    <div className="flex flex-col">
                        ...
                        <span className={`text-[10px] font-bold ${theme === 'retro' ? 'text-[#8B261D]/60' : 'text-[#FFD700]'} uppercase tracking-[0.2em] mt-1.5 opacity-80`}>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            onClick={handleSave}
                            className={`flex items-center gap-2 px-5 py-2 ${theme === 'retro' ? 'bg-[#8B261D] text-white hover:bg-[#6D1E16]' : 'bg-[#FFD700] text-black hover:bg-[#C5A028]'} font-bold text-xs rounded transition-all shadow-[0_4px_15px_rgba(212,175,55,0.2)]`}
                        >
                            <Save size={16} />
                ...
                <div className="flex-1 overflow-y-auto px-8 py-8 space-y-10 custom-scrollbar">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between px-1">
                            <h3 className={`text-base font-bold ${theme === 'retro' ? 'text-[#8B261D]' : 'text-[#FFD700]'} tracking-wider`}>
                        ...
                        <div className={`${theme === 'retro' ? 'bg-[#F4EFE0]/50 border-black/10' : 'bg-zinc-900/40 border-zinc-800/60'} rounded-xl p-8 space-y-6 border`}>
                            <div className="space-y-2">
                                ...
                                <select
                                    className={`w-full ${theme === 'retro' ? 'bg-white border-black/10 text-black' : 'bg-[#050505] border-zinc-800 text-zinc-300'} rounded-lg px-4 py-3 text-sm focus:border-[#FFD700]/50 focus:outline-none transition-all appearance-none`}
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className={`w-full ${theme === 'retro' ? 'bg-white border-black/10 text-black' : 'bg-[#050505] border-zinc-700 text-white'} rounded-lg px-4 py-3 text-sm focus:border-[#FFD700]/50 focus:outline-none transition-all placeholder:text-zinc-700`}
                                        placeholder="google"
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <select
                                        className={`w-full ${theme === 'retro' ? 'bg-white border-black/10 text-black' : 'bg-[#050505] border-zinc-700 text-white'} rounded-lg px-4 py-3 text-sm focus:border-[#FFD700]/50 focus:outline-none transition-all appearance-none`}
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className={`w-full ${theme === 'retro' ? 'bg-white border-black/10 text-black placeholder:text-zinc-400' : 'bg-[#050505] border-zinc-700 text-white placeholder:text-zinc-700'} rounded-lg px-4 py-3 text-sm focus:border-[#FFD700]/50 focus:outline-none transition-all font-mono`}
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className={`w-full ${theme === 'retro' ? 'bg-white border-black/10 text-black placeholder:text-zinc-400' : 'bg-[#050505] border-zinc-800 text-zinc-300 placeholder:text-zinc-700'} rounded-lg px-4 py-3 text-sm focus:border-[#FFD700]/50 focus:outline-none transition-all`}
                        ...
                        <div className={`${theme === 'retro' ? 'bg-[#F4EFE0]/50 border-black/10 text-black' : 'bg-zinc-900/40 border-zinc-800/60'} rounded-xl p-8 space-y-6 border`}>
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className={`w-full ${theme === 'retro' ? 'bg-white border-black/10 text-black placeholder:text-zinc-400' : 'bg-[#050505] border-zinc-800 text-zinc-300 placeholder:text-zinc-700'} rounded-lg px-4 py-3 text-sm focus:border-[#FFD700]/50 focus:outline-none transition-all font-mono`}
                                    placeholder="sk-..."
                                />
                            </div>
                        </div>
