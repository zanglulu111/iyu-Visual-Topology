...
export const CD_GENDER_AURA: ConceptBaseItem[] = withGenderSignal([
  ...
  { id: 'cd_gender_feminine_severe', name: '冷峻女性气质', nameEn: 'Severe Feminine', group: 'A. 女性化呈现', groupEn: 'A. Feminine Presentation', def: '女性化轮廓中带严厉、克制和距离感，适合权力或制度身份。', defEn: 'Feminine silhouette with severity, restraint, and distance, suited to power or institutional identity.', subjectScope: UNIVERSAL_HUMAN_SCOPE, ontologyLevel: 1, eras: ALL_REAL_ERAS, affects: ['face', 'body', 'pose', 'costume'], risk: 'clean' },

  { id: 'cd_gender_masculine_soft', name: '柔和男性气质', nameEn: 'Soft Masculine', group: 'B. 男性化呈现', groupEn: 'B. Masculine Presentation', def: '男性化骨架或气质中保留温和、松弛和低攻击性。', defEn: 'Masculine frame or mood with gentleness, ease, and low aggression.', subjectScope: UNIVERSAL_HUMAN_SCOPE, ontologyLevel: 1, eras: ALL_REAL_ERAS, affects: ['face', 'body', 'pose', 'costume'], risk: 'clean' },
  { id: 'cd_gender_masculine_sharp', name: '锋利男性气质', nameEn: 'Sharp Masculine', group: 'B. 男性化呈现', groupEn: 'B. Masculine Presentation', def: '男性化呈现更干脆、棱角清楚，强调行动力和判断压迫。', defEn: 'Crisper masculine presentation with clear edges, action readiness, and decisive pressure.', subjectScope: UNIVERSAL_HUMAN_SCOPE, ontologyLevel: 1, eras: ALL_REAL_ERAS, affects: ['face', 'body', 'pose', 'costume'], risk: 'clean' },
  { id: 'cd_gender_masculine_solid', name: '厚重男性气质', nameEn: 'Solid Masculine', group: 'B. 男性化呈现', groupEn: 'B. Masculine Presentation', def: '重心、肩背和站姿更稳定，带可靠、迟缓或压迫性的重量。', defEn: 'Stable weight, shoulders, back, and stance, carrying reliability, slowness, or pressure.', subjectScope: UNIVERSAL_HUMAN_SCOPE, ontologyLevel: 1, eras: ALL_REAL_ERAS, affects: ['body', 'pose', 'costume'], risk: 'clean' },
  { id: 'cd_gender_masculine_refined', name: '精致男性气质', nameEn: 'Refined Masculine', group: 'B. 男性化呈现', groupEn: 'B. Masculine Presentation', def: '男性化呈现被护理、礼仪或审美训练打磨得干净精准。', defEn: 'Masculine presentation polished by grooming, etiquette, or aesthetic discipline.', subjectScope: UNIVERSAL_HUMAN_SCOPE, ontologyLevel: 1, eras: ALL_REAL_ERAS, affects: ['face', 'body', 'costume'], risk: 'clean' },

  { id: 'cd_gender_androgynous_clean', name: '干净中性', nameEn: 'Clean Androgynous', group: 'C. 中性/混合呈现', groupEn: 'C. Androgynous / Mixed', def: '性别信号被收束成干净线条，重点落在脸、比例和造型秩序。', defEn: 'Gender signals reduced into clean lines, with focus on face, proportion, and styling order.', subjectScope: UNIVERSAL_HUMAN_SCOPE, ontologyLevel: 1, eras: ALL_REAL_ERAS, affects: ['face', 'body', 'costume'], risk: 'clean' },
