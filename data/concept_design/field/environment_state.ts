...
import { withEnvironmentStateMeta } from './environmentMeta';
...
export const CD_ATMOSPHERE: LibraryItemDef[] = [
...
].map(item => withEnvironmentStateMeta(item, 'ATMOSPHERE'));
...
export const CD_PARTICLES: LibraryItemDef[] = [
...
].map(item => withEnvironmentStateMeta(item, 'PARTICLES'));
