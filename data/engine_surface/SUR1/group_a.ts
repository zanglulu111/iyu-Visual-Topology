...
export const SUR1_GROUP_A: LibraryCategoryDef = {
  ...
  items: [
    ...
    { 
      ...
      core: "严密的预案 vs 不可控的墨菲定律。每一步精准计算背后都潜伏着连锁崩溃的可能。",
      coreEn: "Meticulous planning vs uncontrollable Murphy's Law. Behind every precise calculation lurks the potential for cascading collapse.",
