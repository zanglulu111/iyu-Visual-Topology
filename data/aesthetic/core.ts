...
const AES_COLOR_PALETTE: LibraryItemDef[] = AES_COLOR_PRESETS;
...
export const AESTHETIC_ENGINE_BLOCKS: NarrativeBlockDef[] = [
  ...
  // Legacy fashion/prop blocks are kept out of the active schema.
...
export const AESTHETIC_ENGINE_LIBRARY: LibraryCategoryDef[] = [
  ...
  { id: "aes_lens_series_lib", name: "镜头系列", nameEn: "LENS SERIES", desc: "Optical characteristics.", items: AES_LENS_SERIES },
  { id: "aes_texture_render_lib", name: "画面质感", nameEn: "VISUAL质感", desc: "Surface/Render Style.", items: AES_TEXTURE_RENDER },
  { id: "aes_physical_grain_lib", name: "物理颗粒", nameEn: "PHYSICAL GRAIN", desc: "Grain & Noise.", items: AES_PHYSICAL_GRAIN },
  { id: "aes_base_tone_lib", name: "显影协议", nameEn: "COLOR PROFILE", desc: "Base contrast, saturation and dynamic range.", items: AES_BASE_TONE },
  { id: "aes_color_science_lib", name: "色彩科学", nameEn: "COLOR SCIENCE", desc: "Film stock or LUT emulation.", items: AES_COLOR_SCIENCE },

  // --- New Fixed Module Libraries (Stylized) ---
  { id: "aes_art_medium_lib", name: "创作介质", nameEn: "ART MEDIUM", desc: "The artistic medium used.", items: AES_ART_MEDIUM },
  ...
  { id: "aes_angle_lib", name: "拍摄角度", nameEn: "CAMERA ANGLE", desc: "Camera height & tilt.", items: AES_ANGLE },
  { id: "aes_focal_length_lib", name: "焦段", nameEn: "FOCAL LENGTH", desc: "Field of view.", items: AES_FOCAL_LENGTH },
  { id: "aes_depth_lib", name: "景深/焦点", nameEn: "DEPTH OF FIELD", desc: "Focus range.", items: AES_DEPTH },
  { id: "aes_shutter_lib", name: "快门", nameEn: "SHUTTER", desc: "Motion blur.", items: AES_SHUTTER },
  { id: "aes_lens_fx_lib", name: "光学特效", nameEn: "OPTICAL FX", desc: "Optical imperfections.", items: AES_LENS_FX },
  { id: "aes_optical_format_lib", name: "光学格式", nameEn: "OPTICAL FORMAT", desc: "Aspect ratio.", items: AES_OPTICAL_FORMAT },
  
  { id: "aes_gender_lib", name: "性别气质", nameEn: "GENDER", desc: "Presentation.", items: AES_GENDER },
  { id: "aes_age_lib", name: "年龄质感", nameEn: "AGE", desc: "Time on body.", items: AES_AGE },
  { id: "aes_body_type_lib", name: "身体体态", nameEn: "BODY TYPE", desc: "Silhouette.", items: AES_BODY_TYPE },
  { id: "aes_ethnicity_lib", name: "现实血统", nameEn: "ETHNICITY", desc: "Human ethnicities.", items: AES_ETHNICITY },
  { id: "aes_species_lib", name: "幻想种族", nameEn: "SPECIES", desc: "Supernatural races.", items: AES_SPECIES },
  // REMOVED aes_class_lib
  
  { id: "aes_hair_color_lib", name: "发色", nameEn: "HAIR COLOR", desc: "Color.", items: AES_HAIR_COLOR },
  { id: "aes_hair_style_f_lib", name: "发型-女式", nameEn: "HAIRSTYLE FEM", desc: "Feminine.", items: AES_HAIR_FEM },
  { id: "aes_hair_style_m_lib", name: "发型-男式", nameEn: "HAIRSTYLE MASC", desc: "Masculine.", items: AES_HAIR_MASC },
  { id: "aes_eye_color_lib", name: "瞳色", nameEn: "EYE COLOR", desc: "Iris color.", items: AES_EYE_COLOR },
  { id: "aes_eye_shape_lib", name: "眼型", nameEn: "EYE SHAPE", desc: "Shape.", items: AES_EYE_SHAPE },
  { id: "aes_eye_fx_lib", name: "眼部特效", nameEn: "EYE FX", desc: "Special pupils.", items: AES_EYE_FX },
  { id: "aes_face_features_lib", name: "面部特征", nameEn: "FACE FEATURES", desc: "Skin details.", items: AES_FACE_FEATURES },
  { id: "aes_expression_lib", name: "面部表情", nameEn: "EXPRESSION", desc: "Emotional state.", items: AES_EXPRESSION },
  { id: "aes_skin_texture_lib", name: "皮肤质感", nameEn: "SKIN TEXTURE", desc: "Surface details.", items: AES_SKIN_TEXTURE },
  { id: "aes_body_features_lib", name: "身体特征", nameEn: "BODY FEATURES", desc: "Body details.", items: AES_BODY_FEATURES },
  { id: "aes_occupation_lib", name: "职业身份", nameEn: "OCCUPATION", desc: "Role.", items: AES_OCCUPATION },
  { id: "aes_persona_lib", name: "潮流人设", nameEn: "PERSONA", desc: "Personas.", items: AES_PERSONA },
  // Legacy fashion/prop libraries are kept out of the active schema.
  { id: "aes_action_static_lib", name: "静态动作", nameEn: "STATIC ACTION", desc: "Poses.", items: AES_ACTION_STATIC },
  { id: "aes_action_dynamic_lib", name: "动态动作", nameEn: "DYNAMIC ACTION", desc: "Movement.", items: AES_ACTION_DYNAMIC },
  { id: "aes_action_complex_lib", name: "人类行为", nameEn: "HUMAN BEHAVIOR", desc: "Dramatic.", items: AES_ACTION_COMPLEX },
  { id: "aes_creature_size_lib", name: "体型量级", nameEn: "CREATURE SIZE", desc: "Scale.", items: AES_CREATURE_SIZE },
  { id: "aes_creature_class_lib", name: "生物纲目", nameEn: "CREATURE CLASS", desc: "Classification.", items: AES_CREATURE_CLASS },
  { id: "aes_creature_element_lib", name: "元素属性", nameEn: "ELEMENTAL", desc: "Affinities.", items: AES_CREATURE_ELEMENT },
  { id: "aes_creature_head_lib", name: "头部特征", nameEn: "HEAD FEATURES", desc: "Head details.", items: AES_CREATURE_HEAD },
  { id: "aes_creature_body_lib", name: "身体部件", nameEn: "BODY PARTS", desc: "Body details.", items: AES_CREATURE_BODY },
  { id: "aes_creature_mood_lib", name: "生物心情", nameEn: "CREATURE MOOD", desc: "Mood.", items: AES_CREATURE_MOOD },
  { id: "aes_creature_action_lib", name: "生物行为", nameEn: "CREATURE ACTION", desc: "Actions.", items: AES_CREATURE_ACTION },
  { id: "aes_creature_texture_lib", name: "生物质感", nameEn: "CREATURE TEXTURE", desc: "Tactile.", items: AES_CREATURE_TEXTURE },
  // skin_era_lib removed as per request
  { id: "aes_light_mood_lib", name: "光影基调", nameEn: "LIGHTING MOOD", desc: "Tone.", items: AES_LIGHT_MOOD },
  { id: "aes_light_type_lib", name: "照明类型", nameEn: "LIGHTING TYPE", desc: "Source.", items: AES_LIGHT_TYPE },
  { id: "aes_scene_real_lib", name: "现实场景", nameEn: "REAL SCENE", desc: "Physical Env.", items: AES_SCENE_REAL },
  { id: "aes_scene_surreal_lib", name: "超现实场景", nameEn: "SURREAL SCENE", desc: "Fantasy Env.", items: AES_SCENE_SURREAL },
  { id: "aes_scene_abstract_lib", name: "抽象场景", nameEn: "ABSTRACT SCENE", desc: "Psychological.", items: AES_SCENE_ABSTRACT },
  // UPDATED LIB MAPPING
  { id: "aes_atmosphere_lib", name: "天气/大气", nameEn: "ATMOSPHERE", desc: "Weather & Atmosphere.", items: AES_ATMOSPHERE },
  { id: "aes_particles_lib", name: "粒子", nameEn: "PARTICLES", desc: "Suspended Particles.", items: AES_PARTICLES },
  
  { id: "aes_light_direction_lib", name: "光投射方向", nameEn: "LIGHT DIRECTION", desc: "Position.", items: AES_LIGHT_DIRECTION },
  { id: "aes_light_shape_lib", name: "光投影形状", nameEn: "LIGHT SHAPE", desc: "Texture.", items: AES_LIGHT_SHAPE },
  { id: "aes_color_palette_lib", name: "美术配色", nameEn: "COLOR PALETTE", desc: "Palette.", items: AES_COLOR_PALETTE },
  { id: "aes_poster_style_lib", name: "海报风格", nameEn: "POSTER STYLE", desc: "Graphics.", items: AES_POSTER_STYLE },
  { id: "aes_render_real_lib", name: "画质增强 (写实)", nameEn: "QUALITY (REAL)", desc: "Photorealism Boosters.", items: AES_RENDER_REAL },
  { id: "aes_render_art_lib", name: "画质增强 (美术)", nameEn: "QUALITY (ART)", desc: "Art Quality Boosters.", items: AES_RENDER_ART },
  // Keep base render for fallback
  { id: "aes_render_lib", name: "画质增强", nameEn: "QUALITY ENHANCEMENT", desc: "Boosters.", items: [...AES_RENDER_REAL, ...AES_RENDER_ART] }
];
