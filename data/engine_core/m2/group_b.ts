...
export const ENCOUNTERS_GROUP_B: LibraryItemDef[] = [
    {
        ...
        core: "A面：发现身世的真相也可以是一种巨大的解放——你终于不用再做'他们的孩子'了。一条全新的自我定义之路在你面前展开。/ B面：起源的虚构——如果我的来处是一个谎言，那建立在这个来处之上的'我'，又有多少是真的？关键张力：你是被血缘定义的，还是被选择定义的？ | 实在界穿刺: 起源不是一个事实——它是一个被讲述的故事。所有的'我从哪里来'都是叙事建构。",
    ...
    },
    {
        ...
        core: "A面：被诬陷的经历可以铸造出最坚硬的内在——当全世界都说你有罪的时候，你仍然选择相信自己。这种信念一旦经历过炼狱，就再也不会动摇。/ B面：真相与证据的脱节——你是清白的，但世界的运作逻辑不看'真相'，只看'证据'。关键张力：如果全世界的证据都指向你——你还能坚持你的清白多久？ | 实在界穿刺: '真相'和'被证明的真相'是两件完全不同的事情。",
    ...
    },
    {
        ...
        core: "A面：失忆可以是一种激进的重生——没有过去的包袱，你可以完全从零开始定义自己。你不再是你的历史，你只是此刻的自己。/ B面：能指链的断裂——没有记忆就没有身份。你变成了一个没有坐标的点，漂浮在绝对的虚无之中。关键张力：如果你恢复了记忆，发现'过去的你'是一个你不想成为的人——你还要回去吗？ | 实在界穿刺: '我'不是一个实体——'我'是一串记忆的串联效果。断开记忆，'我'就消失了。",
        ...
        reference: "《谍影重重》中醒来丧失记忆只能依靠身体本能的伯恩；《记忆碎片》里用拍立得和纹身确认自己存在的莱纳德。",
    ...
    },
    {
        ...
        core: "A面：来自过去的信息可以是一份迟到的礼物——死去的人终于对你说出了活着时说不出口的话。/ B面：压抑物的回归（Return of the Repressed）——过去没有死。它只是在等一个时机，用一封信的形式重新爬回你的现在。关键张力：这个秘密——知道了之后更痛苦，还是不知道更痛苦？ | 实在界穿刺: 时间不能保护你远离真相——它只是延迟了真相到达你的日期。",
    ...
    },
    {
        ...
        core: "A面：如果你是唯一记得'真实版本'的人，也许这意味着你拥有一种别人没有的洞察力——你的'不合群'恰恰是你的清醒。/ B面：集体的疯狂——当所有人都坚持天空是绿色的，而你看到的是蓝色，你会开始怀疑自己的眼睛。关键张力：是我疯了，还是世界疯了？——如果这两个选项同样可怕呢？ | 实在界穿刺: '客观事实'从来不是客观的——它是多数人的记忆共识。",
    ...
    },
    {
        ...
        core: "A面：知道真相可以是一种使命——你成了唯一有能力揭开黑幕的人。这份危险的知识赋予了你独特的责任和力量。/ B面：世界的后台被揭开——你曾经信任的每一个微笑、每一次握手，可能都是一个更大棋局中的棋步。关键张力：你揭露了真相之后——有人会相信你吗？还是他们更愿意继续活在谎言里？ | 实在界穿刺: '日常生活'不是中性的背景——它是一层被精心维护的幕布。",
    ...
    },
    {
        ...
        core: "A面：一旦你识破了操纵，你就获得了一种几乎不可摧毁的自我信任——因为你经受住了最残酷的认知审判。/ B面：认知抹杀——对理性的自信被系统性地、日复一日地侵蚀。你不是突然崩溃的——你是被缓慢地、温柔地推向深渊的。关键张力：如果连你自己都开始相信'也许我真的错了'——那么'正确的记忆'还有什么意义？ | 实在界穿刺: 记忆不是一座保险箱——它是一块橡皮泥，任何有耐心的人都能重新捏造它。",
    ...
    },
    {
        ...
        core: "A面：偶像倒塌之后，你终于不再需要仰望任何人了——你被迫开始用自己的眼睛看世界，而不是通过他的眼睛。/ B面：理想我（Ideal Ego）的破碎——你最深层的精神结构建立在他身上。他倒了，你发现自己也站不住了。关键张力：你恨的是他骗了你，还是恨自己把太多的'自己'放在了另一个人身上？ | 实在界穿刺: 所有的'伟大人物'背后都站着一个普通人——你崇拜的从来不是他，而是你投射在他身上的幻象。",
    ...
    },
    {
        ...
        core: "A面：目击暴力也是一种觉醒——你看到了'文明社会'的幕布背后真正在发生的事情。这种知识虽然可怕，但它是真实的。/ B面：纯真的丧失不可逆——你无法'忘掉'你看到的东西。它会永远住在你的脑海里，像一根刺。关键张力：你要站出来说话吗？说话意味着安全的终结。沉默意味着良知的终结。 | 实在界穿刺: '不知道'是一种保护机制——一旦你知道了，你就再也回不到不知道的状态。",
    ...
    },
    {
        ...
        core: "A面：内心被看见也可以是一种深层的被理解——也许你一直渴望有人真正知道'你在想什么'。/ B面：精神上的赤裸——你的思想不再属于你自己。你成了一个被打开的手术台上的标本。关键张力：如果有人读了你最黑暗的想法——他们会选择理解你，还是远离你？ | 实在界穿刺: 你以为的'内心世界'并不安全——它只是还没有被入侵，不是不能被入侵。",
    ...
    },
    {
        ...
        core: "A面：身份被盗可以倒逼你思考——如果名字、证件和社交账号都可以被复制，那真正不可复制的'我'到底是什么？/ B面：我是谁？如果系统说我不是我——那我就真的不存在了。你的存在不取决于你是谁，而取决于档案说你是谁。关键张力：如果另一个人比你更像'你'——谁才是真的？ | 实在界穿刺: '身份'不住在身体里——它住在数据库里。谁控制数据库，谁就控制'你是谁'。",
    ...
    },
    {
        ...
        core: "A面：内部声音也许是你从未听过的另一个'自己'——被压抑的智慧、被否认的直觉、被遗忘的呼唤。/ B面：主体被寄生——你的大脑不再只属于你。有一个'它'在里面运行，而你无法关掉它。关键张力：如果这个声音说的是你清醒时不敢承认的真话——你要听它的吗？ | 实在界穿刺: '自我'不是一个统一体——它内部有多个声音在争夺控制权。你以为的'我的想法'只是其中声音最大的那个。",
    ...
    },
    {
        ...
        core: "A面：谎言曝光也可以是一种卸下重担——你终于不用再演了。虽然真相是痛苦的，但至少你可以做回那个不完美的、真实的自己。/ B面：你不仅失去了别人的信任，更恐怖的是——你发现你已经分不清哪个是谎言的'你'，哪个是真实的'你'了。关键张力：如果你用谎言伪装了太久，那个'真实的你'——还在吗？ | 实在界穿刺: 谎言的最大代价不是被揭穿——而是说谎者自己也忘了真相是什么。",
    ...
    },
    {
        ...
        core: "A面：发现记忆是虚假的，也意味着你拥有一种强大的自我建构能力——你的大脑为了保护你，创造了一个比现实更美的版本。/ B面：如果最温暖的那段记忆是假的——那你的整个人格是建立在什么之上的？沙子？关键张力：一段虚假的记忆，如果它曾经给了你力量和安慰——它还算'假的'吗？ | 实在界穿刺: 记忆不是录像带——它是一部你每次播放都在重新剪辑的电影。",
    ...
    },
    {
        ...
        core: "A面：禁忌知识也可以是一种启蒙——伊甸园之外虽然没有神的庇护，但它有自由和真实。/ B面：知识的诅咒——一旦你理解了某些东西的运作机制，你就永远无法天真地享受它了。理解了魔术的原理之后，魔术就死了。关键张力：如果天堂的代价是无知——你还愿意回去吗？ | 实在界穿刺: '知道'不是力量——有些'知道'是终身的枷锁。",
    ...
    },
    {
        ...
        core: "A面：深度伪造暴露了一个更深的问题——在一个所有影像都可以被制造的时代，'看到'不再等于'相信'。这种觉醒虽然痛苦，但它摧毁了一个更大的幻觉。/ B面：你的面孔不再属于你。有人可以用你的脸做任何事情，而你无法阻止。关键张力：在一个任何影像都可以被伪造的世界里——'真相'还有可能被证明吗？ | 实在界穿刺: '眼见为实'这个人类最古老的认知基石，已经碎了。",
    ...
    },
    {
        ...
        core: "A面：临终的真话往往是最坦诚的——死亡剥夺了一切面具。你听到的可能是这个人一辈子最真实的一句话。/ B面：无法核实的真相——他说完就死了。你将永远无法确认他最后说的是真话还是又一个谎言。关键张力：一个死人的话——你应该信吗？信了之后，你的生活应该因此改变吗？ | 实在界穿刺: 死亡不是真相的终结——有些真相只有在死亡的门槛上才会被说出来。",
    ...
    },
    {
        ...
        core: "A面：发现被监控也是一种确认——你对某个系统来说足够'重要'，重要到值得被观察。这种恐惧的反面，是一种诡异的存在感。/ B面：凝视的无处不在——你不再有'独处'的可能。即使关上门，也有一双眼睛在看。你变成了一个永远在演出的角色。关键张力：当你知道自己在被看的时候——你还能做'真实的自己'吗？ | 实在界穿刺: 隐私不是一种天然状态——它是一种你只有在失去之后才意识到它的存在的东西。",
    ...
    },
    {
        ...
        core: "A面：误判之后的重建，往往比原来的版本更加坚固——因为你不再盲信任何外部权威了。/ B面：不可逆的残酷——你无法回到那个还没做决定的时间点。你的人生因为一个'错误的事实'而永远拐弯了。关键张力：如果你能回到做决定的那一刻——你会选择不知道那个'事实'吗？ | 实在界穿刺: '信息'不等于'真相'——但我们每天都在用未经验证的信息做生死决定。",
    ...
    },
    {
        ...
        core: "A面：数据可以是一种解放——它终结了悬而未决的怀疑。不管结果是什么，至少你终于知道了。/ B面：一串字母和数字重新定义了你的身份、你的家庭、你的命运。你没有变——但你的世界变了。关键张力：如果一份报告说你不是你父亲的儿子——这改变了什么？改变了一切？还是什么都没改变？ | 实在界穿刺: 科学数据不是中性的——它是一把会把你的叙事劈成两半的斧头。",
