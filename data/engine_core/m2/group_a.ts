...
export const ENCOUNTERS_GROUP_A: LibraryItemDef[] = [
    {
        ...
        core: "A面：被解雇可以是一次强制性的觉醒——那份工作也许早就在吞噬你，只是你没有勇气自己离开。/ B面：你的社会身份在一瞬间被抹除——在这个系统里，你从来不是一个人，只是一个工号。关键张力：你恨的是失去这份工作，还是恨自己居然需要这份工作来证明自己存在？ | 实在界穿刺: 你在系统中的'不可替代性'是一个幻觉。",
    ...
    },
    {
        ...
        core: "A面：金钱的清零可以是一次彻底的减法——剥掉所有物质外壳后，你终于看到了自己到底是什么。/ B面：在一个万物皆可标价的系统里，资产归零等于存在归零——你不再被任何交易网络承认。关键张力：如果你的银行余额变成了零，你自己的'余额'是多少？ | 实在界穿刺: 价值是一层随时可以蒸发的虚构。",
    ...
    },
    {
        ...
        core: "A面：被冤枉可以激发最强烈的抗争意志——不公正是革命者的燃料。/ B面：卡夫卡式噩梦——你越试图自证清白，系统就越认定你有罪，因为'无辜的人不会如此激动'。关键张力：如果证据说你有罪，而你知道自己无辜——你相信证据还是相信自己？ | 实在界穿刺: 法律保护的不是正义，而是程序。",
    ...
    },
    {
        ...
        core: "A面：面具被撕碎也可以是一种解放——你不再需要维持那个精心编造的公众形象了。真实的你终于暴露在阳光下。/ B面：在全景敞视的凝视下，你变成了一具赤裸的标本——每个人都在看，没有人在理解。关键张力：他们看到的那个'真实的你'——真的是你吗？还是只是另一个更残酷的标签？ | 实在界穿刺: 隐私不是一种权利，而是一种特权——它随时可以被收回。",
    ...
    },
    {
        ...
        core: "A面：失去固定住所可以是游牧式自由的起点——你终于不再被一个地址捆绑。/ B面：庇护所的丧失不只是物理事件——它意味着你在这座城市的地图上被擦除了。关键张力：一个'家'到底是四面墙，还是一种你对世界的归属感？ | 实在界穿刺: 你对一个空间的'所有权'只是一份随时可以撕毁的合同。",
    ...
    },
    {
        ...
        core: "A面：战争可以锻造出一个人从未被发现的勇气、情义和生命力——有些人在和平中沉睡，在战火中觉醒。/ B面：身体被征用为杀戮工具。你的名字被换成编号。你的生死被换算成一个统计指标。关键张力：如果你在战场上变成了一个你不认识的人——回来之后，你还回得去吗？ | 实在界穿刺: 个人命运在宏大叙事面前的绝对渺小。",
    ...
    },
    {
        ...
        core: "A面：被禁本身可以成为最强大的传播力——所有伟大的禁书都比畅销书活得更久，因为权力亲手为它们贴上了'危险'的认证。/ B面：话语权的阉割——你的创造物被系统像垃圾一样处理。你用生命写下的东西，在权力眼里连'错误'都算不上，只是'不存在'。关键张力：如果没有人能读到你的作品——它还存在吗？ | 实在界穿刺: 表达的自由不是天赋的，而是被允许的。",
    ...
    },
    {
        ...
        core: "A面：被组织抛弃可以打碎一种更深层的幻觉——'忠诚会被回报'。这种幻灭虽然痛苦，但它让你第一次为自己而活。/ B面：大他者的恶意——你不是被遗忘，而是被精心选中作为牺牲品。你的忠诚恰恰是你被利用的原因。关键张力：你恨的是组织背叛了你，还是恨自己居然信了这么久？ | 实在界穿刺: 忠诚是一种单向合同——你签了，它从来没签。",
    ...
    },
    {
        ...
        core: "A面：对簿公堂也可以是一种澄清——在法庭上，你终于有机会让真相被所有人听到。/ B面：语言的暴力——生活被卷入繁琐而致命的法律程序，每个词都可能是绞索。关键张力：法律到底是正义的工具，还是有钱人的武器？ | 实在界穿刺: 在法律面前人人平等，除了请不起律师的人。",
    ...
    },
    {
        ...
        core: "A面：落榜可以是另一条路的起点——所有被制度筛掉的人里，藏着大量被制度无法测量的天赋。/ B面：被筛选机制淘汰不只是'没考好'——它是一种系统性的宣判：'你不够格。'关键张力：这个考试测量的到底是你的能力，还是你对这个系统的服从度？ | 实在界穿刺: 所谓'公平竞争'的筛选机制，本身就是一种暴力。",
    ...
    },
    {
        ...
        core: "A面：被拒于门外可以让你重新审视'那扇门'——也许门里面的东西并不值得你放弃尊严去乞求。/ B面：无国籍者的恐怖——你被困在两个法律体系的缝隙中，不属于任何一边。关键张力：如果你在任何地方都不被承认——你还是一个'人'吗？ | 实在界穿刺: 国境线不是地理概念，而是权力概念——它决定谁算'人'。",
    ...
    },
    {
        ...
        core: "A面：被替代可以倒逼你去发现那些'不可被替代'的部分——机器能计算，但它不能痛苦，不能爱，不能创造意义。/ B面：价值归零的恐慌——如果你做的事情任何人（或任何东西）都能做，那'你'的独特性在哪里？关键张力：你的价值到底来自你做的事，还是来自你是谁？ | 实在界穿刺: 能力是一种会过期的货币。",
    ...
    },
    {
        ...
        core: "A面：失去继承权也意味着失去了一条锁链——你再也不用做'谁家的儿子'了。/ B面：家族契约的背叛——不是陌生人夺走了你的东西，而是最亲近的人。关键张力：你争的到底是那笔钱，还是'我在这个家里到底算不算数'的承认？ | 实在界穿刺: 继承不是爱的证明，而是权力的延续。",
    ...
    },
    {
        ...
        core: "A面：隔离也可以是一次强制性的停顿——在被迫停下来的日子里，你终于有机会面对那些你一直在用忙碌逃避的东西。/ B面：例外状态（State of Exception）——生物生存权压倒了一切自由权。你不是公民，你是一个需要被管控的生物体。关键张力：如果安全和自由不可兼得——你选哪一个？ | 实在界穿刺: 日常秩序不是自然状态，而是一种随时可以被暂停的许可。",
    ...
    },
    {
        ...
        core: "A面：当货币变成废纸，一种更古老、更真实的交换方式可能复苏——人开始用技能、信任和情感来交易。/ B面：符号与现实的脱钩——你用一生换来的数字，系统用一秒钟就让它归零。关键张力：如果金钱是一种集体幻觉——那你用青春换来的到底是什么？ | 实在界穿刺: 货币的'价值'从来不在纸上——在纸上的那个数字，只是信仰。",
    ...
    },
    {
        ...
        core: "A面：基础设施瘫痪剥掉了一切'便利'的外衣——你被迫重新发现自己作为生物体的原始能力：生火、取水、辨别方向。/ B面：文明是一层极薄的壳——它只需要 72 小时的停电就会退化为弱肉强食的丛林。关键张力：当电恢复的时候，你还能回到之前那个'正常'的自己吗？还是你已经看到了自己在黑暗中的另一面？ | 实在界穿刺: 你所依赖的'正常生活'基于一个你从未注意到的脆弱系统。",
    ...
    },
    {
        ...
        core: "A面：瘟疫也是一面照妖镜——它暴露了谁是真正的英雄（逆行者），谁是平时伪装的好人（囤积者）。灾难是人性的X光机。/ B面：所有的'他人'瞬间变成了潜在的致命威胁。握手、拥抱、亲吻——一切亲密行为都变成了死亡赌博。关键张力：为了活下去，你愿意把门关到多紧？ | 实在界穿刺: 人类社会的底层契约（互相接触、互相信任）是有前提条件的。",
    ...
    },
    {
        ...
        core: "A面：旧秩序的坍塌也许是必要的——有些系统太腐烂了，只有通过剧烈的断裂才能让新的东西生长出来。/ B面：但革命的恐怖在于，替换旧系统的新系统往往只是旧系统的另一个面孔——压迫者换了名字，被压迫的位置没有变。关键张力：推翻了暴君之后，空出来的那个王座——谁来坐？ | 实在界穿刺: '系统'不是外部的建筑——它内化在每一个生活在其中的人心里。所以即使你推倒了高墙，墙的蓝图还在你的脑子里。",
    ...
    },
    {
        ...
        core: "A面：从高处坠落可以让你看到一个你从未见过的世界——从上面看到的风景是虚假的。只有坠落之后，你才能看到社会的地基长什么样。/ B面：阶层坠落最残忍的不是贫穷，而是你还记得富裕的味道。你的身体已经到了底层，但你的习惯和期望还留在上面——这种撕裂才是最深的痛苦。关键张力：你到底是'从上面掉下来的人'，还是'终于回到了你本来属于的地方'？ | 实在界穿刺: 阶层不是你'到达'的地方——它是一种随时可以被撤销的许可证。",
    ...
    },
    {
        ...
        core: "A面：饥饿可以是一种残酷的真实——它剥掉了一切虚伪的社交礼仪，让你看到谁才是真正愿意和你分享最后一块面包的人。/ B面：文明外壳剥落后的残酷——为了一口吃的，你会做到什么程度？这个答案会让平时的'你'感到恐惧。关键张力：在饥饿面前，道德是一种选择，还是一种伪装？ | 实在界穿刺: 人类所有的价值体系，都建立在一个前提之上——'肚子是满的'。",
