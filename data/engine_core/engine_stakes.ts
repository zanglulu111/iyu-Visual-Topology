...
export const ENGINE_STAKES: LibraryItemDef[] = [
    ...
    {
        id: "stake_exile",
        name: "永久放逐", nameEn: "Eternal Exile",
        group: "A. 符号性死亡", groupEn: "Symbolic",
    ...
    {
        id: "stake_aphasia",
        name: "失语", nameEn: "Aphasia/Silence",
        group: "A. 符号性死亡", groupEn: "Symbolic",
    ...
    {
        id: "stake_stigma",
        name: "污名化", nameEn: "Stigmatization",
        group: "A. 符号性死亡", groupEn: "Symbolic",
    ...
    },
    {
        ...
        name: "丧失母语", nameEn: "Language Loss",
        group: "A. 符号性死亡", groupEn: "Symbolic",
    ...
    },
    {
        ...
        name: "剥夺制服", nameEn: "Stripped Uniform",
        group: "A. 符号性死亡", groupEn: "Symbolic",
        def: "被公开剥夺勋章和制服。",
    ...
    {
        id: "stake_dehuman",
        name: "成为非人", nameEn: "Dehumanization",
        group: "B. 本体论崩塌", groupEn: "Ontological",
    ...
    {
        id: "stake_merging",
        name: "强行融合", nameEn: "Forced Merging",
        group: "B. 本体论崩塌", groupEn: "Ontological",
        def: "与憎恨的人或物融为一体。",
    ...
    },
    {
        ...
        name: "彻底物化", nameEn: "Objectification",
        group: "B. 本体论崩塌", groupEn: "Ontological",
        def: "被当作物品对待，甚至被做成物品。",
    ...
    },
    {
        ...
        name: "平庸的同化", nameEn: "Assimilation",
        group: "C. 道德的堕落", groupEn: "Moral",
    ...
    {
        id: "stake_blue_pill",
        name: "虚假的幸福", nameEn: "The Blue Pill",
        group: "C. 道德的堕落", groupEn: "Moral",
    ...
    {
        id: "stake_faith_loss",
        name: "信仰破碎", nameEn: "Loss of Faith",
        group: "C. 道德的堕落", groupEn: "Moral",
    ...
    {
        id: "stake_tyrant",
        name: "成为暴君", nameEn: "Becoming Tyrant",
        group: "C. 道德的堕落", groupEn: "Moral",
        def: "为了秩序而牺牲自由，变成独裁者。",
    ...
    },
    {
        ...
        name: "被复仇吞噬", nameEn: "Consumed by Revenge",
        group: "C. 道德的堕落", groupEn: "Moral",
        def: "为了复仇不惜毁灭世界。",
    ...
    {
        id: "stake_death",
        name: "物理死亡", nameEn: "Physical Death",
    ...
    {
        id: "stake_torture",
        name: "永恒折磨", nameEn: "Eternal Torture",
        group: "D. 物理毁灭", groupEn: "Ruin",
        def: "肉体遭受持续的、无法解脱的折磨。",
    ...
    {
        id: "stake_loss_love",
        name: "失去所爱", nameEn: "Loss of Loved One",
        group: "D. 物理毁灭", groupEn: "Ruin",
        def: "自己活着，但所有在乎的人都死了。",
    ...
    {
        id: "stake_disease",
        name: "绝症", nameEn: "Terminal Illness",
        group: "D. 物理毁灭", groupEn: "Ruin",
    ...
    {
        id: "stake_experiment",
        name: "实验体", nameEn: "Experimented On",
        group: "D. 物理毁灭", groupEn: "Ruin",
        def: "被疯狂科学家切开研究。",
    ...
    },
    {
        ...
        name: "虚空吞噬", nameEn: "Void Consumed",
        group: "D. 物理毁灭", groupEn: "Ruin",
        def: "被黑洞或虚无物质分解。",
