...
export const STAKES_GROUP_C: LibraryItemDef[] = [
    // ============================================================
    // GROUP C. 实在界截面 (Real Amputation) — 20 Items
...

    {
        ...
        group: "C. 实在界截面", groupEn: "Real Amputation",
        ...
        core: "A面：失去一部分身体反而让你学会了用剩余的部分活得更精密——残缺迫使你发展出常人不会拥有的代偿能力和敏锐。/ B面：但伤残最残酷的部分不是'不能做'——是'记得自己曾经能做'。幻肢痛不是身体在疼，是记忆在疼。关键张力：你拒绝接受'新的正常'，还是在残缺中找到了一种旧身体从未拥有的力量？ | 代价回路 (Castration): 肉身完整性的物理截除——不可撤销。",
    ...
    },
    {
        ...
        core: "A面：当外在的美被摧毁后，你才真正知道谁爱的是'你'而不是'你的脸'。毁容是最残酷的人际关系筛选器。/ B面：但人类是视觉动物——我们不可能不对面孔做出反应。当每个陌生人的第一反应都是移开目光，你会内化这种目光，开始相信自己确实不值得被看见。关键张力：在一个崇拜外貌的世界里——你能接受自己成为那个'让别人不舒服'的存在吗？ | 代价回路 (Castration): 社交皮肤的扒除——镜像阶段的二次创伤。",
    ...
    },
    {
        ...
        core: "A面：失去一种感官会让其余感官变得超常敏锐——盲人的听力、聋人的观察力往往超越常人。丧失一个通道反而打开了另一个。/ B面：但代偿不能替代那个失去的维度本身。你不是'拥有了更好的听力'——你是永远无法再看到日落的颜色了。那个维度的全部体验，对你变成了一种概念而非感觉。关键张力：一个从未见过颜色的人和一个失去颜色的人——谁的损失更大？ | 代价回路 (Castration): 世界的一条维度被从感知面板上拔掉。",
    ...
    },
    {
        ...
        core: "A面：沉默有时比任何言辞都更有力量——不说话的人反而可以让所有人去猜测他的意图，沉默本身成为一种权力工具。/ B面：但这不是你选择的沉默——是被强加的。当你遭受不公却无法呐喊、当你满怀爱意却无法告白、当你知道真相却无法说出——沉默就从'选择'变成了'牢笼'。关键张力：如果世界夺走了你的声音——你是找到新的表达方式，还是让沉默吞噬你？ | 代价回路 (Castration): 灵魂直接发声的通道被物理截除——小美人鱼的沉默。",
    ...
    },
    {
        ...
        core: "A面：身体的变形有时是内在真相的外化——也许你的外表终于和你灵魂深处那个'不属于这个世界'的秘密对齐了。/ B面：但这种'对齐'不是你选择的。你照镜子看到的不是'新的我'——是'一个逐渐变得不认识的东西'。你的手在变，你的皮肤在变，唯一没变的是那个困在变化中的意识。关键张力：如果你的身体变成了你灵魂的真正形态——你还想变回去吗？ | 代价回路 (Castration): 人类形态的不可逆坍缩——卡夫卡《变形记》的终极法则。",
...

    {
        ...
        core: "A面：知道自己什么时候死反而让你拥有了大多数人没有的东西——紧迫感。每一天都不再可以浪费，每一段关系都必须被认真对待。倒计时是最好的效率工具。/ B面：但倒计时也是最残忍的折磨——你开始用'还剩几天'来度量一切。你的笑是'还能笑几次'的笑，你的拥抱是'也许是最后一次'的拥抱。关键张力：如果你知道终点——你是加速奔跑，还是在原地坐下来看风景？ | 代价回路 (Castration): 时间轴被从'无限'切割为'有限'——死神变成了你的日程管理员。",
    ...
    },
    {
        ...
        core: "A面：长期疼痛会改变你的忍耐阈值——你能承受的东西远超你自己的想象。持续的痛苦锻造了一种骇人的韧性。/ B面：但慢性疼痛最恶毒的地方在于它不是高潮——它是永恒的中低频嗡鸣。你不会崩溃，你只会被磨得越来越薄，直到某一天你发现自己已经忘了'不疼'是什么感觉。关键张力：你能和永远不会消失的疼痛共存多久——一年、十年、还是余生？ | 代价回路 (Castration): 静默与舒适的永久收缴。",
    ...
    },
    {
        ...
        core: "A面：衰老赋予了一种年轻时不可能获得的东西——对有限的感知。只有意识到自己在减少的人，才会真正珍惜剩余的。/ B面：但衰老不是诗意的缓慢——是每天早上醒来发现又有一个'曾经轻松就能做到的事'做不到了。你的身体在一块一块地退出你，而你没有任何手段阻止。关键张力：当你的身体不再听你的话——你是你的身体，还是你的身体只是你暂住的房子？ | 代价回路 (Castration): 时间本身对肉体的逐帧降解。",
    ...
    },
    {
        ...
        core: "A面：死亡是赋予生命意义的唯一框架——如果你永远不会死，你也永远不会开始活。正因为会结束，所以每一刻才有重量。/ B面：但死亡不在乎你的意义——它只是一个物理过程。它不会等你准备好，不会等你说完最后一句话，不会让你的故事有一个体面的结尾。关键张力：你是为了死亡而活——还是因为死亡在活？ | 代价回路 (Castration): 实在界的终极截面——没有例外、没有续集、没有二刷。",
    ...
    },
    {
        ...
        core: "A面：目睹过死亡的人获得了一种活着的人很少拥有的清醒——你再也不会认为'明天总会来'。每次告别都像最后一次——因为你见过它真的是最后一次的样子。/ B面：但这份清醒不是礼物——是一块永远嵌在视网膜上的碎片。你闭上眼看到的不是黑暗，而是那个你没能阻止的画面的无限回放。关键张力：你能把目睹的死亡变成活下去的理由——还是它会变成你无法入睡的理由？ | 代价回路 (Castration): 他者之死的创伤直视——替代性创伤的终极形态。",
...

    {
        ...
        core: "A面：绝对的限制也是绝对的简化——当空间被缩减到几平方米，你会被迫向内在探索。很多人在牢笼里找到了外面永远不会发现的东西。/ B面：但内在探索是文人的浪漫化。真实的终身监禁是每天看着同一堵墙、闻着同一种味道、听着同一种铁门声，你的世界被压缩成一个永恒的'现在'。关键张力：如果你的身体被关住了但你的思想是自由的——你到底是自由的还是不自由的？ | 代价回路 (Castration): 空间自由度的归零——时间变成了纯粹的存量消耗。",
    ...
    },
    {
        ...
        core: "A面：在极端奴役中，身体可能被征用了，但某种内在的不屈——你无法奴役一个人的恨意和希望——本身就构成了最后的抵抗。/ B面：但这种'最后的抵抗'是局外人的诗意化。真实的奴役是你的身体如此疲惫，以至于连恨的力气都被剥夺了。你不是'选择屈服'——你是被彻底磨成了一个无条件反射的劳动装置。关键张力：一个连反抗的念头都被体力消耗殆尽的人——和一件工具还有什么区别？ | 代价回路 (Castration): 肉身所有权的彻底让渡。",
    ...
    },
    {
        ...
        core: "A面：被迫与不可忍受的他者共存，有时会让你发展出一种意想不到的共情——因为你没有逃避的选择，你只能选择理解。/ B面：但大多数被迫共生不产生理解——只产生缓慢的互相磨损。你不能逃，他也不能逃，你们像两块锁在一起的石头，在彼此的摩擦中一点一点地碎裂。关键张力：和一个你无法摆脱的人被绑在一起——你是学会了爱他，还是学会了比恨更深的东西？ | 代价回路 (Castration): 独立性的物理性剥除——连孤独的权利都被没收。",
    ...
    },
    {
        ...
        core: "A面：实验的逻辑是'少数人的痛苦换取多数人的答案'——在某种极端的功利主义框架下，这甚至是可辩护的。/ B面：但'可辩护'不等于'可接受'。当你被绑在手术台上时，你不关心这个实验能救多少人——你只关心那个正在切开你的人的手有没有在抖。关键张力：如果你的痛苦真的能拯救一千人——你'应该'自愿吗？如果你不自愿——有人有权强迫你吗？ | 代价回路 (Castration): 从'目的'到'手段'的本体论降级。",
    ...
    },
    {
        ...
        core: "A面：加缪说'我们必须想象西西弗斯是幸福的'——在永恒的无意义劳动中，你可以选择创造属于自己的意义，哪怕那个意义只对你一个人有效。/ B面：但加缪没有推过那块石头。真实的永恒劳作不是哲学思考的机会——是肌肉撕裂、关节磨损、意识在疲劳中逐渐降格为一种没有主语的状态。关键张力：如果劳动本身没有意义——你推的那块石头是你的诅咒还是你唯一的同伴？ | 代价回路 (Castration): 存在被压缩为纯粹的物理功输出——西西弗斯的巨石。",
...

    {
        ...
        core: "A面：当你什么都没有的时候，你也什么都不怕——恐惧是有产者的特权。赤贫反而给了你一种'反正没了就没了'的暴烈自由。/ B面：但贫穷不是自由——是每一个念头都被'下一顿饭在哪'占满的认知紧缩。你没有精力去思考意义、美、爱情——你的全部CPU都在运算生存。关键张力：是贫穷让人堕落，还是让人压根没有机会'不堕落'？ | 代价回路 (Castration): 物质安全感的彻底蒸发——马斯洛底层的崩塌。",
    ...
    },
    {
        ...
        core: "A面：饥饿把一切精神追求都降格为奢侈品——它是最残忍的唯物主义教科书：你现在知道了，你不是你的灵魂，你首先是你的胃。/ B面：但饥饿最可怕的不是疼痛——是它对你道德判断的侵蚀。当你饿到第三天，你开始重新计算你曾经认为不可逾越的底线。关键张力：你饿到什么程度会放弃尊严——三天？七天？还是你永远不会？你敢回答吗？ | 代价回路 (Castration): 文明外壳被饥饿酸液溶解——灵魂的最终物质检验。",
    ...
    },
    {
        ...
        core: "A面：被剥去一切遮蔽后，你和环境之间的那层'文明隔膜'消失了——你终于像一个真正的动物那样感受到了世界的温度。原始的、未经过滤的、真实的。/ B面：但人类进化了几万年就是为了给自己加上这层隔膜。当它被强行撕掉时，你发现'文明'不是束缚——是保护。没有它，你不是'更真实'了，你是更脆弱了。关键张力：一个被剥去所有遮蔽的人——是回到了动物的自由，还是跌入了动物的无助？ | 代价回路 (Castration): 文明隔膜的撕除——肉体直接暴露于实在界的无差别碾压。",
    ...
    },
    {
        ...
        core: "A面：替罪羊因其无辜而拥有一种绝对的道德优势——你的清白越被忽视，你的道德地位就越不可撼动。/ B面：但道德优势不能阻止鞭子落在你背上。当你无辜的身体正在疼痛时，'历史会证明一切'是一句毫无意义的安慰。关键张力：你是接受成为替罪羊的'崇高命运'——还是你只想停止疼痛？ | 代价回路 (Castration): 因果律的断裂——惩罚不对应罪行，罪行没有惩罚。",
    ...
    },
    {
        ...
        core: "A面：作为人质，你的存在突然变得极其有'价值'——因为有人愿意为你交换某种东西。某种扭曲的方式里，你的生命从来没有像现在这样被重视过。/ B面：但这种'价值'不是你的——是你绑在谁身上的。你不是一个'人'，你是一件可以被标价的抵押品。你的生死不取决于你做了什么，而是取决于电话那头的人愿不愿意付钱。关键张力：当你的命运完全取决于另一个人——你能做的只有等待。而等待本身就是一种慢性死亡。 | 代价回路 (Castration): 自决权的剥离——你的存亡变成他人的博弈变量。",
