...
export const OUTCOMES_GROUP_B: LibraryItemDef[] = [
    ...
    // ============================================================
    {
        ...
        core: "A面：气味是最诚实的时间机器——它不经过大脑直接触发。你的身体比你更忠诚于那段记忆。/ B面：但你被一个感官细节绑架了。整个世界变成了地雷阵——任何相似的气味都可能把你炸回去。关键张力：那个感官是通道还是陷阱？ | 实在余痕(Σ): 你闻到了那个味道。腿软了一秒。然后假装什么都没发生。",
    ...
    },
    {
        ...
        core: "A面：你把一个普通物件升格成了圣物——它是你和那段经历之间最后的物理连接。/ B面：但那个东西本身什么都不是。你的全部感情被投射到了一个不会回应的物体上。关键张力：你在保存记忆——还是在崇拜一个替代品？ | 实在余痕(Σ): 那个东西掉地上了。你的心跳停了一拍。它只是个东西。但不是。",
    ...
    },
    {
        ...
        core: "A面：一句话浓缩了一切——你不需要讲完整个故事，这句话就够了。语言的最高效率。/ B面：但那句话也冻住了你。你用一句话封存了一段经历，但封存也是一种逃避展开。关键张力：那句话是你的结晶——还是你的封印？ | 实在余痕(Σ): 你又说了那句话。每次说的时候你以为自己在解释。其实你在躲。",
    ...
    },
    {
        ...
        core: "A面：每次经过那里都是一次无声的朝圣。那个地方因为你的经历获得了神圣性——从地图上普通的一点，变成了内心地图的中心。/ B面：但你也被那个地点困住了。你不敢走那条路。你可以扔掉遗物、关掉歌曲——但你不能从地球上删掉一个地方。关键张力：那个地点是你的圣地——还是你的禁区？ | 实在余痕(Σ): 你绕了三条街。就是为了不经过那个路口。",
    ...
    },
    {
        ...
        core: "A面：你的生命被那个日期切成了两个人——之前的你和之后的你。这种分裂本身证明你经历过足够重大的事件。/ B面：但日期每年都会回来。你无法删掉它、无法跳过它。每一次它到来，你都要重新经历一次那个切口。关键张力：每年的那一天你是在纪念——还是在重新受伤？ | 实在余痕(Σ): 日历翻到了那一页。你假装没注意到。但你的身体知道。",
    ...
    },
    {
        ...
        core: "A面：你的身体忠实地记住了那段经历——一个疤、一个姿势、一种痛。身体不撒谎。/ B面：但铭刻也意味着你的身体不让你忘记。你的肉身变成了一份你无法销毁的档案。关键张力：那是你活过的证据——还是一份你被迫随身携带的判决书？ | 实在余痕(Σ): 你换衣服时看到了那个疤。你已经不记得疼了。但它还在。",
    ...
    },
    {
        ...
        core: "A面：你把一套日常升格成了圣礼——固定的时间、固定的顺序、固定的器物。它是你在混乱世界中唯一还能控制的秩序，你的最后堡垒。/ B面：但仪式的每一步都被锁死了。你不敢换一个杯子、不敢改一秒钟。有人不小心动了那个位置，你的反应像被侵犯。关键张力：你在维持秩序——还是你已经变成了仪式的零件？ | 实在余痕(Σ): 到了那个时间。你做了那件事。你已经不记得为什么了。但不做不行。",
    ...
    },
    {
        ...
        core: "A面：那张脸覆盖了你记忆中的原版——你用最后的印象替换了所有印象。这说明最后那一刻对你最重。/ B面：但你也失去了那个人的全部。你只留下了一帧——其他所有帧都被覆盖了。关键张力：你记住了最重要的——还是你丢掉了全部只留了一个碎片？ | 实在余痕(Σ): 你想起他的笑。想不起来。只有最后那个表情。",
    ...
    },
    {
        ...
        core: "A面：誓言已经脱离了语境——但你还在执行。你的忠诚超越了时间和条件。/ B面：但你忠诚的对象已经不在了。你在为一个幽灵守约。你的守信变成了一种自我绑架。关键张力：你在信守承诺——还是你在用承诺逃避面对它已经失效了？ | 实在余痕(Σ): 你答应了他的事，你还在做。他早就不在了。但你停不下来。",
    ...
    },
    {
        ...
        core: "A面：梦是你意识不愿面对、但潜意识坚持重播的东西——那个反复出现的梦说明有什么真相你还没消化。/ B面：但这个梦你做了几百遍了。它不在帮你消化——它在让你重复。你醒来是疲惫的，因为睡眠中仍在经历那件事。关键张力：那个梦是在帮你处理——还是潜意识陷进了死循环？ | 实在余痕(Σ): 你又做了那个梦。你在梦里想叫醒自己。但你做不到。",
    ...
    },
    {
        ...
        core: "A面：你把不可承受的混乱整理成了一个有因果的故事——语言成了你的盔甲。/ B面：但那个'版本'已经不是真的了。你讲了太多遍，连自己都信了简化版。关键张力：你讲给别人的版本——是你对经历的掌控，还是对真相的逃避？ | 实在余痕(Σ): 你又讲了一遍那个故事。每次都更流畅。每次都离真相更远。",
    ...
    },
    {
        ...
        core: "A面：你的欲望需要出口，旧的关闭了，你自动找了新的。你没有停下来。/ B面：但替代物永远不是原件。你在新的人身上寻找旧的影子，读着同一个故事。关键张力：你真的爱上了新的人——还是在用他们填那个旧的洞？ | 实在余痕(Σ): 你抱着新的人。但你闭上眼睛的时候想的是谁？",
    ...
    },
    {
        ...
        core: "A面：你的神经系统比意识更诚实——它替你记住了你不愿承认的连接。身体替你拉响了警报。/ B面：但禁忌触点会扩散。最初一个场景，然后一切相关的都变成禁区。你的世界在缩小。关键张力：那些禁忌在保护你——还是在把你的世界缩成越来越小的房间？ | 实在余痕(Σ): 你避开了那个东西。然后避开相关的。然后发现需要避开的越来越多。",
    ...
    },
    {
        ...
        core: "A面：背影是最不设防的告别——一个人转身走掉的方式比面对你的方式更真实。/ B面：但背影也是最残忍的画面——你看不到那个人的脸。他走时是什么表情？你永远不会知道。关键张力：你记住的背影是离开的真相——还是你永远无法验证的猜测？ | 实在余痕(Σ): 他走了。你想叫住他。但你没有。然后他就不见了。",
    ...
    },
    {
        ...
        core: "A面：有些谎言是建筑材料——你用它撑住了一段关系。你的不诚实拯救了你不忍心看倒塌的东西。/ B面：但谎言会生长。一个小谎需要十个来维护。你住在一座谎言建筑里，每面墙都是秘密。关键张力：那个谎言保护了什么——但它永远改变了你和真相的关系。 | 实在余痕(Σ): 你说了一句不是真的话。那句话活了下来。真相死了。",
    ...
    },
    {
        ...
        core: "A面：声音比面孔更难伪造——你可以看错一张脸，但你认错一个声音的概率很低。那个声音是你和那个人之间最后的活物。你的耳朵替你保存了一个还会呼吸的证据。/ B面：但声音也是最残忍的幽灵——它太真了。你在超市听到了类似的声调，整个人僵在了货架前面。你的手机里还存着那条语音，你一年听八十遍。关键张力：你保存那个声音是为了记住——还是因为你还没准备好接受那个声音的主人已经不在了？ | 实在余痕(Σ): 你在街上听到了一个声音。你转过头。不是那个人。从来不是。",
    ...
    },
    {
        ...
        core: "A面：食物是最日常的仪式——一起吃饭比一起睡觉更像家人。那道菜凝缩了一整段关系的温度：谁做的、怎么做的、在哪张桌子上吃的。你吃的不是食物，是时间。/ B面：但味觉化石也是最精准的定时炸弹——你在一家陌生餐厅吃到了同样的味道，眼泪在第三口的时候掉下来了。你控制不了你的舌头。关键张力：你是在吃饭——还是在用舌头做考古？ | 实在余痕(Σ): 你尝到了那个味道。筷子停在了半空。然后你放下了碗。",
    ...
    },
    {
        ...
        core: "A面：那个人最深的遗产不是物件、不是照片——是你身体里的一个动作。你无意识地继承了他的手势，这比任何遗嘱都更真实。你见到镜子里自己做了那个动作的时候，你会愣两秒。/ B面：但你的身体不是你自己的了。每次做那个动作，你都在无意间扮演一个不在场的人。你不知道这是爱，还是一种无法驱散的附身。关键张力：那个手势是他留给你的礼物——还是你变成了他的复制品？ | 实在余痕(Σ): 有人说你笑起来跟他很像。你愣了一秒。然后你再也不知道那个笑是你的，还是他的。",
    ...
    },
    {
        ...
        core: "A面：有些东西不说出来反而更重——沉默可以承载比语言更多的内容。你们之间有一段空白，但那段空白不是虚无，它是一整栋被压缩了的建筑。不说，是因为一说就要全部倒塌。/ B面：但不说也是一种暴力——沉默可以变成一道永久的隔墙。你们坐在同一张桌子前，但中间隔了一整条河。关键张力：那个沉默保护了你们的关系——还是杀死了它？ | 实在余痕(Σ): 你们又见面了。你们聊了很多。但你们真正要说的那句话——一如既往地——没有说。",
