...
export const OUTCOMES_GROUP_C: LibraryItemDef[] = [
    ...
    // ============================================================
    {
        ...
        core: "A面：反复确认是你对不确定性的最后抵抗——你在用行动堵住焦虑的缝隙。每确认一次就安心一秒。/ B面：但安心只持续一秒。然后你又要确认一次。你的确认在喂养它试图消灭的焦虑。关键张力：你确认的是事实——还是在重复一个永远无法完成的仪式？ | 圣状余痕(Σ): 你已经检查了三遍。你知道没问题。但手还是伸了出去。",
    ...
    },
    {
        ...
        core: "A面：你在试图找到那个分岔点——如果你能精确地定位错误发生的瞬间，你就还有改正的可能。复盘是拒绝放弃的表现。/ B面：但你在修改一个不存在的草稿。真实只发生了一次，它不接受编辑。关键张力：你是在分析——还是在用思维替代行动？ | 圣状余痕(Σ): 你又想到了那句话。如果当时说的是另一句。如果。如果。如果。",
    ...
    },
    {
        ...
        core: "A面：你把痛苦转化成了生产力——每一份加班都是一道防线。忙碌让你没有时间崩溃。这是一种有效的自我管理。/ B面：但你不是在工作，你是在逃。工作是你发明的麻醉剂。一旦停下来，所有东西会一次性涌回来。关键张力：你是在建设什么——还是在躲避什么？ | 圣状余痕(Σ): 凌晨三点。你不困。你只是不敢关灯。",
    ...
    },
    {
        ...
        core: "A面：道歉是你对他最后能做的事——虽然迟了，但你在用不断的忏悔证明你知道自己做了什么。/ B面：但道歉已经变成了自我安慰的仪式。你不是在赎罪，你是在用道歉喂养自己的内疚回路。关键张力：你渴望的是他的原谅——还是自己原谅自己？ | 圣状余痕(Σ): 对不起。对不起。对不起。他听不到。但你停不下来。",
    ...
    },
    {
        ...
        core: "A面：你的警觉曾经救过你——在那个最危险的时刻，是你的过度敏感让你活了下来。你的身体学到了教训。/ B面：但危险已经过去了。你的身体不知道。它还在按战时标准运转，每一个门响都是警报。关键张力：你的警觉是在保护你——还是危险已经结束但你的身体拒绝停战？ | 圣状余痕(Σ): 门响了。没什么事。但你的心已经跳到了嗓子眼。",
        ...
        core: "A面：搜索是你和那个人最后的连接方式——虽然触不到，但你还能知道他在继续。你没有完全失去他。/ B面：但每一次搜索都会再割你一刀。他过得好你痛，过得不好你也痛。关键张力：你在维持连接——还是在反复揭开伤口？ | 圣状余痕(Σ): 你又打开了那个页面。看了。放下手机。然后又拿起来了。",
    ...
    },
    {
        ...
        core: "A面：自我惩罚是你唯一剩下的公正——既然没人惩罚你，你自己来。你在用痛苦证明你不是无所谓的人。/ B面：但惩罚永远不够。因为你不知道'够'是什么标准。回路没有终点。关键张力：你是在赎罪——还是在用痛苦替代你不敢面对的另一种感受？ | 圣状余痕(Σ): 你又对自己做了那件事。然后恨自己做了。然后又做了。",
    ...
    },
    {
        ...
        core: "A面：你在试图把上一次搞砸的东西这一次做对——每段新关系都是一次重考，你在用新人修正旧答案。/ B面：但你不是在修正，你是在重复。你选的人、犯的错——结构一模一样。关键张力：你以为在找新的爱——但你只是在用不同的脸重演同一出戏？ | 圣状余痕(Σ): 又是同一种人。又是同一种痛。你说下次不会了。但你知道会。",
    ...
    },
    {
        ...
        core: "A面：排练是你对那段未完成对话的尊重——你在寻找最精确的语言来配得上那个时刻的重量。/ B面：但你排练了一千遍也没说出口。排练本身变成了替代品——你用想象中的说取代了真实的说。关键张力：你还打算说吗——还是排练本身已经成了目的？ | 圣状余痕(Σ): 这次我要告诉他。这次一定。然后你又沉默了。",
    ...
    },
    {
        ...
        core: "A面：潮汐说明你还活着——只有有感觉的人才会有潮汐。每一次退潮都是一小段平静。/ B面：但每次涨潮都回到同一个高度。你以为在好转，其实只是在退潮。好转是假象，周期是真的。关键张力：你在愈合——还是只是在两次疼痛之间休息？ | 圣状余痕(Σ): 今天好多了。你刚这么想。然后傍晚又来了。",
    ...
    },
    {
        ...
        core: "A面：照顾别人是你找到的最有尊严的活法——你的痛苦变成了别人的安慰。你把碎片拼成了一面盾牌。/ B面：但你用别人的需求填满了自己的空洞。一旦没人需要你，你就坍塌了。关键张力：你在给予——还是在用给予逃避面对自己？ | 圣状余痕(Σ): 所有人都说你太好了。但没人问过你好不好。",
    ...
    },
    {
        ...
        core: "A面：麻木是你的紧急制动——当感受太多的时候，关掉感觉是你仅存的自保手段。/ B面：但麻木不是真的不痛——它只是延迟了付款。等它退去的时候，所有感受一次性涌回来，比之前更猛。关键张力：你在自我保护——还是在积攒一次更大的崩溃？ | 圣状余痕(Σ): 整个星期什么都不觉得。然后某个周日下午，毫无征兆地，全部回来了。",
    ...
    },
    {
        ...
        core: "A面：你还有想靠近的冲动——说明你没有完全关闭自己。你还相信连接是值得的。/ B面：但每次靠近到一定距离你就逃走了。你在安全距离和渴望之间做永远的钟摆。关键张力：你怕的是被拒绝——还是怕被接受之后再次失去？ | 圣状余痕(Σ): 你走近了一步。然后退了两步。然后又走近了一步。",
    ...
    },
    {
        ...
        core: "A面：你把自己没被拯救的痛苦转化成了拯救别人的能力——你不想让任何人经历你经历过的事。/ B面：但你拯救的不是他们，是过去的自己。你在别人身上反复修复一个已经无法修复的人。关键张力：你在帮他们——还是在用他们完成你自己未完成的剧本？ | 圣状余痕(Σ): 你又帮了一个人。他好了。但你的那个洞还在。",
    ...
    },
    {
        ...
        core: "A面：告白冲动说明你的良知还在工作——真相在你体内产生了压力，它需要一个出口。这种不安是正直的证据。/ B面：但你想说出来不是为了对方——是为了卸下你自己的重量。告白是一种转嫁，你把你的负担变成了别人的。关键张力：你想说出真相——是为了诚实，还是为了让自己好受？ | 圣状余痕(Σ): 你张了张嘴。又闭上了。真相在嘴边转了一圈又咽了回去。",
    ...
    },
    {
        ...
        core: "A面：幽灵对话让那个人还活在你的内部世界里——你用想象维持了一段不存在的关系。这说明你还在乎。/ B面：但你对话的对象是你自己——你在替他说话。那个'他'已经完全是你的构造。关键张力：你在和他对话——还是在和自己对话的镜像说话？ | 圣状余痕(Σ): 你又在脑子里问了他一句话。然后自己替他回答了。",
    ...
    },
    {
        ...
        core: "A面：控制是你从混乱中抢回来的一小块秩序——你失去了最重要的东西，至少剩下的不能再乱。/ B面：但你控制的半径在不断扩大——越控制越焦虑，越焦虑越控制。你活在一张自己编织的网里。关键张力：你在创造秩序——还是在用秩序逃避那个你控制不了的东西？ | 圣状余痕(Σ): 所有东西都摆好了。一切都在计划内。但你的手在发抖。",
    ...
    },
    {
        ...
        core: "A面：愤怒说明你还没有接受——你认为发生的事情是不公正的。这种不屈服是有力量的。/ B面：但怒气已经变成了你的基调。你不是因为某件事生气——你只是一直在生气。它在慢慢烧你。关键张力：你的愤怒是一种反抗——还是一种你已经无法关闭的后台程序？ | 圣状余痕(Σ): 没什么特别的事。但你就是烦。一直烦。说不出为什么。",
    ...
    },
    {
        ...
        core: "A面：囤积是你对匮乏的本能反应——你失去过太多，现在你确保手边永远有余量。安全感需要库存。/ B面：但'够'的标准在不断提高。你有了十个还想要第十一个。你填不满的不是仓库——是那个洞。关键张力：你在储备安全——还是在用数量麻痹那个'不够'的感觉？ | 圣状余痕(Σ): 你又买了一个。加上之前的够了吗？不够。从来不够。",
    ...
    },
    {
        ...
        core: "A面：等待是你对那段关系最后的忠诚——你还没有单方面宣布结束。只要你还在等，一切就还没有定论。/ B面：但等待已经变成了你逃避往前走的借口。你不是在等他——你是在用等待拒绝接受。关键张力：你在等他回来——还是在用'等'来避免承认他不会回来了？ | 圣状余痕(Σ): 手机响了。不是他。你放下。继续等。",
