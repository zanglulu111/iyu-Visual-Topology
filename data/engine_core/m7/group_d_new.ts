...
export const OUTCOMES_GROUP_D: LibraryItemDef[] = [
    ...
    // ============================================================
    {
        ...
        core: "A面：你的不信任是经验教你的——你被骗过，你的警觉是有理由的。你用怀疑保护了自己。/ B面：但你同时也把所有可能的真诚关在了门外。你的防线保护了你，也隔绝了你。关键张力：你变得更聪明了——还是更孤独了？ | 结局回路 (Residuum): 他对你很好。你知道。但你的第一反应是：他想要什么？",
    ...
    },
    {
        ...
        core: "A面：你的笑里多了一层东西——经历过的人才有的质感。它不再天真，但更真实。/ B面：但你也笑不回去了。那种来自肚子里的、毫无防备的笑，你再也找不到了。你的笑变成了一种表演。关键张力：你的笑更有深度了——还是你永远失去了那种纯粹的快乐？ | 结局回路 (Residuum): 有人说你笑起来不一样了。你说没有。但你知道有。",
    ...
    },
    {
        ...
        core: "A面：那堵墙保护了你——你不会再因为太近而被伤到。你学会了保持安全距离。/ B面：但安全距离也是孤独的距离。你永远只能让人走到这里——不能再近了。关键张力：那堵墙是你的铠甲——还是你的牢房？ | 结局回路 (Residuum): 他想再近一步。你退了。不是不喜欢。是不能。",
    ...
    },
    {
        ...
        core: "A面：你的优先级被重写了——你看到了什么才是真正重要的。你不再为虚假的东西浪费时间。/ B面：但你也可能在矫枉过正——你把旧世界全部否定了，新的也未必是对的。关键张力：你看清了——还是你只是换了一种偏见？ | 结局回路 (Residuum): 以前拼命追的东西摆在面前。你看着它。什么感觉都没有了。",
    ...
    },
    {
        ...
        core: "A面：你的沉默是一种精炼——经历过的人不需要那么多词来装饰。你的每个字都比以前重。/ B面：但你也在慢慢退出和世界的交流。你的沉默可能不是从容——是你已经放弃了被理解。关键张力：你是变得更深了——还是你在慢慢消失？ | 结局回路 (Residuum): 他问你怎么了。你说没事。你确实觉得'没事'已经够了。",
        ...
        core: "A面：你的共情被重新校准了——你比任何人都懂痛苦是什么，所以你对别人的痛有更精确的感受力。/ B面：但精确也会累。你要么对一切痛苦过敏，要么干脆关掉了那个频道。关键张力：你的共情是变深了——还是变形了？ | 结局回路 (Residuum): 有人在哭。你感受到了一切。或者什么也没感受到。没有中间。",
    ...
    },
    {
        ...
        core: "A面：你的时间感被那件事重新校准了——你知道了一秒钟可以装下一辈子的重量。你比别人更懂时间的密度。/ B面：但你也活在一个扭曲的时钟里。该快的慢，该慢的快。你和别人不在同一个时间流速里了。关键张力：你感知到了更深的时间——还是你的时间坏了？ | 结局回路 (Residuum): 五年过去了。感觉像五天。又像五十年。",
    ...
    },
    {
        ...
        core: "A面：你的幽默里多了一根刺——你能看到别人看不到的荒诞。你笑的东西更真实了，只是更少人能一起笑。/ B面：但你也可能失去了笑的能力。不是不想笑——是你的幽默器官被改造了，旧频率接收不到了。关键张力：你的笑变深了——还是你和快乐之间隔了一层什么？ | 结局回路 (Residuum): 大家在笑。你知道那很好笑。但你笑不出来。",
    ...
    },
    {
        ...
        core: "A面：你在独处中找到了一种别人给不了的安全——没有人的空间就没有伤害的可能。你的孤独是一种选择。/ B面：但你的'选择'可能已经变成了'无法'。你不是喜欢独处——你是不会和人相处了。关键张力：你享受孤独——还是你已经忘了怎么不孤独？ | 结局回路 (Residuum): 一个人待着。很安静。可以了。可以了。",
    ...
    },
    {
        ...
        core: "A面：断层说明你经历了真正的事件——你不再是同一个人，这本身就是深度的证明。/ B面：但断层两边的你互相不认识。你翻看旧照片像在看一个陌生人。你和自己的过去失联了。关键张力：你进化了——还是你断裂了？ | 结局回路 (Residuum): 有人提起你以前的样子。你听着。好像在听别人的故事。",
    ...
    },
    {
        ...
        core: "A面：你的情感阈值被重新校准了——你对某些微小的善意变得极度敏感。你的眼泪更诚实了。/ B面：但你在大事面前反而哭不出来了。悲剧来的时候你是干的，广告里一个陌生人的微笑却让你崩了。关键张力：你的眼泪变准了——还是你的情感线路接错了？ | 结局回路 (Residuum): 一个陌生人帮你捡了东西。你差点哭了。你不知道为什么。",
    ...
    },
    {
        ...
        core: "A面：你获得了一种决断力——见过最坏的之后，小事不再纠结。你的优先级清晰得像刀。/ B面：但你也可能被永久地卡住了——你害怕每个选择都会像上次一样带来灾难。关键张力：你是更果断了——还是被恐惧冻住了？ | 结局回路 (Residuum): 菜单摆在面前。你看了很久。点什么都觉得会错。",
    ...
    },
    {
        ...
        core: "A面：你的失眠是一种守夜——你的身体在替你值班，因为你睡着的时候发生过可怕的事。/ B面：但你也在用清醒惩罚自己。你不是睡不着——你是不允许自己睡着。关键张力：你的身体在保护你——还是你在用疲劳自我折磨？ | 结局回路 (Residuum): 凌晨四点。天快亮了。你的眼睛是睁着的。又是一夜。",
    ...
    },
    {
        ...
        core: "A面：你的道德观被现实磨过了一遍——你不再用非黑即白来看世界。你的宽容不是软弱，是见过灰色之后的深度。/ B面：但你也可能滑向了相对主义——如果一切都有道理，那就没有道理。你的宽容可能只是判断力的瘫痪。关键张力：你是变得更宽容了——还是你已经不在乎了？ | 结局回路 (Residuum): 你听到一个人做了坏事。你没有生气。你只是想：我理解。",
    ...
    },
    {
        ...
        core: "A面：你的记忆系统有了自己的优先级——它替你保存了你理智不愿意面对的东西。记忆比你更诚实。/ B面：但你也失去了对记忆的控制。你想记住的淡了，不想记住的清晰得像照片。关键张力：你的记忆在帮你——还是在跟你作对？ | 结局回路 (Residuum): 你忘了他的生日。但你记得那天下午的光线。",
    ...
    },
    {
        ...
        core: "A面：偏好的改变说明你在生长——你的品味跟着你的经历一起进化了。旧的口味装不下新的你。/ B面：但你也失去了那些旧的快乐。你最喜欢的歌不再让你感动了。你怀念那个还能被简单事物打动的自己。关键张力：你的品味升级了——还是你失去了被打动的能力？ | 结局回路 (Residuum): 你尝了一口以前最喜欢的菜。还是那个味道。但你什么都没感觉到。",
    ...
    },
    {
        ...
        core: "A面：你学会了精简——你不再浪费精力在不值得的人身上。你的圈子小了，但每段关系都是真的。/ B面：但你的容量可能不是变精了——是缩小了。你承受不了太多连接了。多一个人就多一份可能的失去。关键张力：你是在筛选——还是在回避？ | 结局回路 (Residuum): 你只剩下三个还联系的人。够了。或者说，已经是极限了。",
    ...
    },
    {
        ...
        core: "A面：你的身体忠实地记录了你的经历——你的姿态就是你活过的证据。身体不会说谎。/ B面：但你可能已经不认识自己的身体了。你曾经昂首走路，现在你低着头。你的身体在替你表达你不承认的东西。关键张力：你的身体在保护你——还是在代替你说出你不愿承认的状态？ | 结局回路 (Residuum): 你在橱窗里看到了自己的影子。那个轮廓不太像你记得的那个人。",
    ...
    },
    {
        ...
        core: "A面：你活在了当下——你不再为不存在的未来焦虑，每一天都过完整了。这是强者的活法。/ B面：但你也失去了期待——没有盼头的日子不是自由，是平坦的荒原。你不是活在当下，是被困在当下。关键张力：你是学会了活在此刻——还是你对明天绝望了？ | 结局回路 (Residuum): 有人问你五年后的计划。你愣了。五年后？你想不出来。",
    ...
    },
    {
        ...
        core: "A面：你发展出了一套新的爱的语法——可能更安静、更谨慎，但每个字都是称过的。你不再挥霍感情了。/ B面：但新的语法别人不一定读得懂。你以为你在爱——对方觉得你冷漠。你的深情变成了别人眼里的距离。关键张力：你的爱变得更真了——还是变得没人能收到了？ | 结局回路 (Residuum): 你很爱他。但你说不出来。你送的东西他也不懂。你们隔着同一种感情互相陌生。",
