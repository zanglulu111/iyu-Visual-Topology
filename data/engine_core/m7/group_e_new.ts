...
export const OUTCOMES_GROUP_E: LibraryItemDef[] = [
    ...
    // ============================================================
    {
        ...
        core: "A面：你的沉默有一种重力——它让别人意识到有些事不该轻率地谈论。你的安静教会了别人尊重深度。/ B面：但你的沉默也让别人窒息。他们不知道你在想什么，也不敢问。你用沉默建了一堵墙，别人被迫住在墙另一边。关键张力：你的沉默保护了什么——同时隔绝了什么？ | 结局回路 (Residuum): 整桌人都安静了。不是因为没话说。是因为你在。",
    ...
    },
    {
        ...
        core: "A面：你在用你的恐惧保护他们——你不想让他们经历你经历过的事。你的警告是爱的一种方式。/ B面：但你也把你的牢房复制给了他们。现在他们也被关在一个他们并不理解的恐惧里。关键张力：你在保护他们——还是在把你的监狱传染给他们？ | 结局回路 (Residuum): 孩子怕水。你也怕。但孩子从来没溺过水。",
    ...
    },
    {
        ...
        core: "A面：你的存在有密度——你带着一种他人能感受到的分量。你让浅薄的场合变得深了一度。/ B面：但你也在无声地拖累别人的快乐。你的重力让别人不敢在你面前开心。关键张力：你的深度是一种礼物——还是一种惩罚？ | 结局回路 (Residuum): 你一走，有人说了句笑话。所有人都笑了。你在的时候他们不敢笑。",
    ...
    },
    {
        ...
        core: "A面：你的保护来自真实的伤口——你知道世界能有多残忍，你不忍心让他们知道。/ B面：但过度保护剥夺了他们长大的机会。你把自己的恐惧变成了他们的围墙。他们安全了，但也窒息了。关键张力：你在保护他们——还是在用保护控制他们？ | 结局回路 (Residuum): 他想出去。你说不行。他问为什么。你说不出来。只是——不行。",
    ...
    },
    {
        ...
        core: "A面：你的经历如此深重，它改变了你身边的磁场。跟你在一起久了的人自动被校准了。这说明你们之间的连接是真的。/ B面：但你在无意间把你的病传给了爱你的人。他们接住了你——也接住了你的阴影。关键张力：他们是在和你共情——还是你的创伤已经殖民了他们？ | 结局回路 (Residuum): 他开始做你的噩梦了。你从来没跟他讲过那些事。",
        ...
        core: "A面：你说出的真相让别人也看到了你看到的东西——你打破了他们的幻觉。清醒是你送给他们的礼物。/ B面：但你也偷走了他们的天真。他们不再能不假思索地相信了。你的觉醒变成了他们的噩梦。关键张力：你让他们看见了真相——还是你把你的偏执传染给了他们？ | 结局回路 (Residuum): 你对她说了一句话。之后她看所有人的眼神都变了。",
    ...
    },
    {
        ...
        core: "A面：那些帮过你的人成为了你的恩人——你给了他们一个永久的好名声。你的故事也成了他们的勋章。/ B面：但你也可能把他们锁在了你的叙事里。他们只是'你故事里的那个角色'。关键张力：你记住了他们的好——还是你用你的故事替代了他们的全部身份？ | 结局回路 (Residuum): 你介绍他时说：'他是当年帮过我的人。'他笑了。但他的眼睛没笑。",
    ...
    },
    {
        ...
        core: "A面：你的压抑保护了表面的平静——你没有让情绪爆炸。你在替所有人维持秩序。/ B面：但压住的水总要从某个缝隙漏出来。你的暴躁、冷漠、突如其来的刻薄——它们都是渗漏。你的家人在替你承接你不愿面对的东西。关键张力：你在控制自己——还是你的情绪换了一条路径流向了别人？ | 结局回路 (Residuum): 你没发脾气。但你妻子突然哭了。你不知道为什么。",
    ...
    },
    {
        ...
        core: "A面：你独自承担了这个秘密——你用沉默保护了别人不必知道。你的隐忍有尊严。/ B面：但秘密会变形它周围的空间。别人感觉到了不对却说不出来。你的秘密变成了弥漫在所有人中间的无名不安。关键张力：你在保护他们不知道——还是你的秘密已经在他们不知道的地方伤害了他们？ | 结局回路 (Residuum): 没人知道。但每个人都觉得哪里不对。空气稠了一点。",
    ...
    },
    {
        ...
        core: "A面：你的内疚让别人意识到了他们可能的疏忽——他们也开始反思自己是否做得不够好。/ B面：但你把不属于他们的重量放到了他们肩上。他们没有做错什么——但现在他们觉得自己也有罪。关键张力：你是在分担——还是在无意识地把你的债务转给了无辜的人？ | 结局回路 (Residuum): 你说了句'对不起'。然后她开始道歉。但她什么都没做错。",
    ...
    },
    {
        ...
        core: "A面：你发出的信号是清晰的——你需要空间，别人尊重了你。你的边界被承认了。/ B面：但你的距离信号太强了。别人不是尊重你——是被你吓跑了。你以为你在保护自己，其实你在驱逐所有人。关键张力：他们给你空间是因为尊重——还是因为你已经让他们害怕了？ | 结局回路 (Residuum): 你想要的空间终于有了。但现在没有人来填了。",
    ...
    },
    {
        ...
        core: "A面：你的经历如此极端，它成了所有人的参照系。你成了他们衡量自身的坐标。/ B面：但你的参照系太重了——别人的痛苦在你面前都自动缩小了。因为'比起你那算什么'他们不敢说自己难受。关键张力：你的故事是一面镜子——还是一个黑洞，吞掉了别人表达痛苦的权利？ | 结局回路 (Residuum): 她想说说自己的事。但她看了你一眼。然后说：'算了，我那个不算什么。'",
    ...
    },
    {
        ...
        core: "A面：你的预警来自真实经验——你比别人更早看到危险信号。你的直觉被训练过了。/ B面：但你把自己的结局当成了所有人的结局。你看到的不是他们的未来——是你的过去在他们身上的倒影。关键张力：你在帮他们预见风险——还是你在强迫他们活在你的剧本里？ | 结局回路 (Residuum): 你对他说：'你会后悔的。'但你说的是你的后悔，不是他的。",
    ...
    },
    {
        ...
        core: "A面：有人愿意替你接着做——你的未竟之事被继承了，你的愿望没有完全消失。/ B面：但那是你的任务，不是他们的。他们替你活了一段你没活完的人生——但那段人生属于你。关键张力：他们是在完成你的愿望——还是被你的幽灵绑架了？ | 结局回路 (Residuum): 你走了。他接着做。他做到了。但他不知道那是不是他自己想做的。",
    ...
    },
    {
        ...
        core: "A面：你在别人心里留下了痕迹——你对他们来说足够重要，重要到你的缺席也有形状。/ B面：但那个洞不会自动愈合。他们围着你的缺席建了新的生活——但新的生活是歪的，因为中间少了一块。关键张力：你的缺席是他们的伤口——还是他们不愿意让那个洞愈合？ | 结局回路 (Residuum): 他们在桌上还放着你的碗。每顿饭都绕过那个位置。",
    ...
    },
    {
        ...
        core: "A面：有人主动替你承担了——这说明你周围有愿意为你付出的人。你的存在触发了善意。/ B面：但他们还的不是他们的债。他们在承受你本应承受的后果。你的逃离有了替罪羊。关键张力：他们是在爱你——还是你的缺席把他们变成了替身？ | 结局回路 (Residuum): 你走了。他留下来收拾。那些烂摊子不是他弄的。但他在扫。",
    ...
    },
    {
        ...
        core: "A面：你的高标准提升了周围人的眼光——跟你在一起久了，他们对自己也要求更多了。/ B面：但你的尺子可能已经是扭曲的了。他们在用一个被伤痛变形的标准来衡量正常生活。关键张力：你提升了他们——还是你把你变形的标准传染给了他们？ | 结局回路 (Residuum): 她开始嫌自己的生活太普通了。你没说过一句话。但她在用你的标准看自己。",
    ...
    },
    {
        ...
        core: "A面：你的经历给那个空间留了一道印记——它因为你变成了一个有故事的地方。/ B面：但那个印记也可能是一种诅咒。别人在那里感到不安，却说不出为什么。你把不安种在了墙里。关键张力：你给那个地方留了一份记忆——还是一个阴影？ | 结局回路 (Residuum): 他们搬进了你住过的房间。一切都重新粉刷了。但有时他们会莫名地不想待在里面。",
    ...
    },
    {
        ...
        core: "A面：你的语气有影响力——你的表达方式被人模仿，说明你的声音留下了回声。/ B面：但你的语气可能是创伤的产物——你的冷淡、你的讽刺、你的小心翼翼——它们都在被你最亲近的人复制。关键张力：他们在学你——还是你的症状在通过语言繁殖？ | 结局回路 (Residuum): 你女儿说了一句话。用的是你的语气。你愣住了。那个语气你从来没有教过她。",
    ...
    },
    {
        ...
        core: "A面：代际循环说明某些模式比个人意志更深——你不是在重复父母，是你们在回应同一个结构性困境。/ B面：但你曾经发过誓。你发誓不做那个人。然后某个周日下午你变成了他。关键张力：你重复了他们——是因为你理解了他们，还是因为你逃不掉？ | 结局回路 (Residuum): 你对孩子说了一句话。然后你听到了你父亲的声音。那是你的声音。",
