...
export const DRIVES_GROUP_B: LibraryItemDef[] = [
...

    {
        ...
        core: "A面：守候是最安静的爱——不要求对方任何事，只让他知道'无论何时回头我都在'。不带条件的在场比语言更有重量。/ B面：但守候也可能是隐性胁迫——你的'在场'变成了对方无法拒绝的道德压力。你以为在给自由，其实是用忠诚绑架。关键张力：你在等一个人，还是在等'被等本身'给你的存在感？ | 驱力回路 (Trieb): 驻守——不是因为有希望，而是因为离开比留下更不可忍受。",
    ...
    },
    {
        ...
        core: "A面：奉献是爱最纯粹的形态——给出的不是多余的东西，而是你自己。把最后一口饭让给孩子的父母，他们的给予不是选择而是本能。/ B面：但无条件的给予也是权力——'我给了你一切'这句话本身就是无法偿还的债。越不求回报对方越无法自由。关键张力：你是在爱他，还是在用'无私'来证明自己的道德优越？ | 驱力回路 (Trieb): 倾注——必须把自己倒空，才能感到自己存在。",
    ...
    },
    {
        ...
        core: "A面：追随是清醒的赌注——我不完全理解你要去哪，但相信跟着你比独自留下有意义。伟大事业是无数追随者的信念汇聚成的。/ B面：但追随和盲从的边界极脆弱。你跟随是因为判断他值得，还是因为害怕自己做选择？关键张力：如果你追随的人走向悬崖——你会跟着跳，还是那才是你独立思考的开始？ | 驱力回路 (Trieb): 跟从——把方向感托付给另一个人换取确定性。",
    ...
    },
    {
        ...
        core: "A面：庇护是最古老的爱——变成一面墙，让风暴打在你身上。母亲弓起身体挡住屋梁不是英雄主义，是生物层面的不可违抗。/ B面：但庇护者往往在保护中窒息了被保护者——你挡住了风暴也挡住了阳光，你的保护让他永远长不大。关键张力：你保护是为了他安全，还是因为'被需要'是你唯一确认自己价值的方式？ | 驱力回路 (Trieb): 遮蔽——把自己变成屋檐，哪怕自己在雨里。",
    ...
    },
    {
        ...
        core: "A面：誓约是对抗时间的最古老武器——我不知道明天的我是谁，但我用今天的我向你担保。婚誓、效忠，都是试图用语言在时间之流中钉下不动的锚。/ B面：但誓约本质是预支无法保证的未来。许下诺言和未来兑现的不是同一个人。关键张力：如果你变了，守约是诚实还是欺骗？背约是背叛还是诚实？ | 驱力回路 (Trieb): 锚定——用语言在时间之流中钉下不动点。",
    ...
    },
    {
        ...
        core: "A面：有些关系不是选择而是拓扑的必然——你们的命运在交叉点打了死结，牵一发而动全身。这种纠缠比爱更深，因为它不需要喜欢彼此。/ B面：但'命运'往往是'不敢离开'的美学包装。说是天注定，也许是你没勇气承认它可以结束。关键张力：如果你们真的是命中注定——还需要努力维持吗？ | 驱力回路 (Trieb): 纠结——两条绳子越挣扎越紧。",
    ...
    },
    {
        ...
        core: "A面：陪葬是爱的绝对化——用消亡证明这段关系是'生活本身'。在所有缠绕中最彻底：拒绝让结局只属于一个人。/ B面：但往往不是爱而是恐惧——不是不能没有他，是不能独自面对没有他的世界。你的'殉情'是对孤独的逃避，而非献祭。关键张力：如果他能开口，是希望你跟来，还是希望你活下去？ | 驱力回路 (Trieb): 随葬——我的存在以你的存在为前提。",
...

    {
        ...
        core: "A面：渗透是最聪明的接近——不挑战防线，而是像水从缝隙流进。等他回神你已是世界的一部分，拔除比接受代价更大。/ B面：但渗透者永远活在被发现的恐惧中——身份建立在谎言上。越融入真实的你就越消失。关键张力：如果你在渗透中真的爱上了这个世界——还能完成原来的任务吗？ | 驱力回路 (Trieb): 浸入——像水一样无声地占据一切缝隙。",
    ...
    },
    {
        ...
        core: "A面：怀柔是最经济的胜利——不需要消灭对手，只需让他觉得合作比对抗更舒服。最持久的帝国不是靠征服，而是让被征服者'自愿'留下。/ B面：但怀柔本质是伪装成温柔的控制——你给了选择的自由，但选项都是你设计的。他以为在做决定，其实在走你的剧本。关键张力：真诚和操控能在同一个行为中共存吗？如果善意是真诚的，它算策略吗？ | 驱力回路 (Trieb): 软化——用温度代替力量。",
    ...
    },
    {
        ...
        core: "A面：迂回是智慧对力量的胜利——正面撞不开的墙，绕到后面也许有门。不是懦弱，是清醒判断：最短路径不一定最有效。/ B面：但迂回的人常常迷路——绕了太多弯后忘了去哪。路径本身变成了目的。关键张力：你是在迂回前进，还是在避免真正的对抗？ | 驱力回路 (Trieb): 绕行——当直线走不通，曲线也是路。",
    ...
    },
    {
        ...
        core: "A面：潜伏是耐心的极致——压下所有冲动，把自己变成石头。等的不是机会而是唯一的时刻。这比任何行动都更需力量。/ B面：但潜伏者常因等太久失去行动力——分不清是在等最佳时机还是逃避风险。关键张力：如果最佳时机永远不来——你是潜伏者还是逃避者？ | 驱力回路 (Trieb): 蛰伏——变成石头，直到世界忘记你。",
    ...
    },
    {
        ...
        core: "A面：织网者无需在场即可控局——力量不来自己身，而来自网上的节点。最高明的棋手不下棋，让棋子自己走。/ B面：但网的维护成本会反噬你——每条线需喂养，每个节点都可能背叛。越控制一切，越被一切控制。关键张力：你是网的主人还是网的囚徒？蜘蛛也被困于己网。 | 驱力回路 (Trieb): 编织——让每根线都通向你。",
    ...
    },
    {
        ...
        core: "A面：培植是最有远见的缠绕——不是回应即时需求，而是为十年后的棋局布子。你在他身上看到了他自己都未见的可能。/ B面：但培植也意味着按你的图纸塑造他——他以为在自由生长，实则根系早已被定局。关键张力：你培养他是为他成为最好自己，还是对你最有用的人？ | 驱力回路 (Trieb): 栽种——在他人身上播下未来的种子。",
...

    {
        ...
        core: "A面：跟踪常源于真实关切——你需要知道他好不好。这种冲动来自深层不确定感：你不相信关系能在视线外存活。/ B面：但跟踪本质是单方面取消隐私的控制——将你的焦虑变成了他的牢笼。你越关心他越窒息。关键张力：你是在关心他，还是在管理自己的焦虑？ | 驱力回路 (Trieb): 凝视——如果我看不到你，你就不存在。",
    ...
    },
    {
        ...
        core: "A面：寄生不一定是恶意——有时你附着只因不知如何独立。你需要他的结构撑住你自己。这是结构性依赖而非选择。/ B面：但寄生终局是宿主衰竭或觉醒——养分有上限。当宿主意识到被消耗，你要么被驱逐，要么同枯死。关键张力：你有能力进化为共生吗？还是离开宿主就不存在了？ | 驱力回路 (Trieb): 吸附——必须附着，否则会蒸发。",
    ...
    },
    {
        ...
        core: "A面：吞噬之爱源于极深的恐惧——你不完全属于我就会消失。所以我要吞没你，让你成为我，你就永远不会离开。这爱的强度与毁灭性同等真实。/ B面：但被吞噬者无法呼吸。你以为在给予，实则在掠夺他独立存在的权利。关键张力：你爱的是他，还是'由你定义的他'？如果他变了你还爱吗？ | 驱力回路 (Trieb): 吞噬——不能拥有全部，就什么都不要。",
    ...
    },
    {
        ...
        core: "A面：过度认同源于极致的崇拜——他活出了你想要的样子，于是你放弃自己的形状去填充他的轮廓。这是一种存在论层面的投降。/ B面：但复制品永无法替代原件——越像他，越提醒自己不是他。你的存在成了没有面容的镜子。关键张力：消除自己是出于爱，还是出于自我厌恶？ | 驱力回路 (Trieb): 复写——把自己变成另一个人的影子。",
    ...
    },
    {
        ...
        core: "A面：情感勒索的可悲在于其痛苦往往是真实的。说'你走我就去死'的人常觉自己真的会死。这是一种无法区分被抛弃和被消灭的恐惧。/ B面：但真实痛苦不能成为控制的理由——你用脆弱做武器，把他变作人质。他留下只因被痛苦绑架。关键张力：若知这最终会让他恨你，还会做吗？ | 驱力回路 (Trieb): 绑架——用伤口做锁链。",
    ...
    },
    {
        ...
        core: "A面：共生绑定是奇特的稳定——两个不完整的人拼在一起刚好运转。各自都是残片，合体则是勉强的完整。/ B面：但这完整的代价是不能成长——你的成长意味着不再需要他。联结建立在彼此残缺之上。关键张力：如果你被治愈了，你们的关系还存在吗？ | 驱力回路 (Trieb): 互锁——两块碎片卡在一起，互为缺口。",
    ...
    },
    {
        ...
        core: "A面：幽灵缠绕是最温柔也最残忍的记忆——你走了但气味还在枕头，习惯刻在身体。不是我在想你，是肌肉在想你。这缠绕无需你在场。/ B面：但这终会让你丧失活在当下的能力——每一段新关系都在与不在场者竞争。你爱的成为回忆本身。关键张力：是在纪念，还是用影子逃避现在？ | 驱力回路 (Trieb): 残留——影子比本人更持久，因它不令人失望。",
