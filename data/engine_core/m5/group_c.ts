...
export const DRIVES_GROUP_C: LibraryItemDef[] = [
...

    {
        ...
        core: "A面：洞察是认知的穿甲弹——别人看表情，你看到恐惧；别人看政策，你看到利益链。这种'看穿'让你永远先人一步。/ B面：但看太清活得很苦——看穿微笑背后的算计，就再无法享受单纯。关键张力：看穿一切的代价是无法信任——这种清醒值得吗？ | 驱力回路 (Trieb): 看穿——必须看透表面之下是什么，哪怕知道后更痛。",
    ...
    },
    {
        ...
        core: "A面：共情是最温柔的穿透——放弃自我视角，从他的眼睛看。那刻你就是他的痛苦，这是人类最珍贵的天赋。/ B面：但深度共情者边界脆弱——太擅长感受别人，分不清情绪是谁的。你变成了吸满别人情绪的海绵。关键张力：共情是能力，还是无法建立自我边界的症状？ | 驱力回路 (Trieb): 穿越——溶解自我边界，住进别人身体。",
    ...
    },
    {
        ...
        core: "A面：解谜者坚信混乱之下必有秩序——随机线索间有隐形线，足够耐心就能拉出。这信念本身就是力量。/ B面：但'一切皆有解释'也可能是病——在随机中强行找规律，把巧合编成阴谋。世界也许没那么有序。关键张力：你找到的模式是真实的，还是大脑无法忍受混乱而编造的？ | 驱力回路 (Trieb): 破解——必须打开每把锁，哪怕门后什么都没有。",
    ...
    },
    {
        ...
        core: "A面：诊断是最精确的穿透——不需治愈，只需说出名字。当人知道自己'怎么了'，痛苦变得可理解，命名即解放。/ B面：但诊断也是暴力——用标签把活人钉死在分类表上。他不再是'人'而是'病例'。关键张力：诊断是帮他理解自己，还是用你的框架替代他的自我认知？ | 驱力回路 (Trieb): 命名——给不可名状的痛苦一个名字。",
    ...
    },
    {
        ...
        core: "A面：预言是对未来的穿透——看到别人看不到的因果链并敢于说出。真预言家是对当下理解极深的人。/ B面：但预言是最孤独的穿透——说出来没人信。越正确越被当疯子。关键张力：预见灾难却无法阻止——知道未来是力量还是诅咒？ | 驱力回路 (Trieb): 预见——被迫看见所有人都还看不到的东西。",
    ...
    },
    {
        ...
        core: "A面：顿悟是认知的地震——不是渐进学习，是所有拼图瞬间到位。看见一直在眼前却未注意的东西。这改变的是你整个人。/ B面：但顿悟也可能是幻觉——大脑渴望意义时会制造假'啊哈时刻'。也许只是焦虑找到了安放框架。关键张力：顿悟是触碰真理，还是大脑为止痛编造的药？ | 驱力回路 (Trieb): 闪电——那一秒，所有灯同时亮起。",
    ...
    },
    {
        ...
        core: "A面：翻译是最谦逊的穿透——不说自己的话，而是用此语言重建彼语言的世界。好翻译者活在两个宇宙，是永恒的中间人。/ B面：但每次转化都是背叛、失真。你用的每个词都染上你的世界观。关键张力：完美翻译可能吗？还是所有理解皆为近似，我们永活在误解中？ | 驱力回路 (Trieb): 转译——在两端架起必然有裂缝的桥。",
...

    {
        ...
        core: "A面：坦白是对自己最暴力的穿透——撕开外壳让人看到不完美的真实。完全裸露的瞬间让你第一次感到自由。/ B面：但坦白也可能是自私——卸下负担转移给对方。是为他好还是为不再内疚？关键张力：有些真相说出对所有人都更糟——你坦白的权利大于他不知情的权利吗？ | 驱力回路 (Trieb): 坦白——把自己劈开给人看。",
    ...
    },
    {
        ...
        core: "A面：直言者是唯一清醒的人——只有你指着大象说是大象。需要勇气更是痛苦的清醒：不说代价更大。/ B面：但你以为在说真话，也许是用'诚实'当武器。关键张力：说真是为了改变，还是因无法忍受虚伪？若真相只带来伤害——还该说吗？ | 驱力回路 (Trieb): 直说——宁愿被恨也不愿被误解。",
    ...
    },
    {
        ...
        core: "A面：揭露是穿透的公共化——不仅看穿真相，还要所有人看到。这需要道德确信：'公众有权知道'。/ B面：但揭露者常低估真相的破坏力——你打开魔盒却无法控制结果。有些真相摧毁的是无辜者。关键张力：你有权揭露真相——但有义务考虑谁会受伤吗？ | 驱力回路 (Trieb): 揭穿——必须把灯打开，不管谁被光灼伤。",
    ...
    },
    {
        ...
        core: "A面：证词是穿透的人格化——当证据可伪造时，亲历者的声音能穿透怀疑。'我是幸存者'比任何证据更有力。/ B面：但记忆是不可靠的证人——创伤扭曲记忆，'亲眼所见'也许早被无意识改写无数次。关键张力：证词是事实，还是你对事实的再创作？ | 驱力回路 (Trieb): 作证——必说出来，因为沉默就是共谋。",
    ...
    },
    {
        ...
        core: "A面：教导是最慷慨的穿透——把一生洞察压缩成一句话。好教师在学生认知里制造裂缝让光照进。/ B面：但教导的权力极易腐败——你决定了他看什么。你打开他的眼睛，但方向是你选的。关键张力：你是帮他看到真相，还是把你的真相装进他的脑子？ | 驱力回路 (Trieb): 启蒙——在他人的认知里凿开一扇窗。",
    ...
    },
    {
        ...
        core: "A面：命名是最原始的穿透——喊出'系统性压迫'，无形苦难突然可被指认。没名字的东西无法战胜。/ B面：但命名也是暴力的简化——词语无法捕捉体验全部。命名的瞬间，不符合的部分被抹掉。关键张力：名字是解放的工具，还是个更精致的牢笼？ | 驱力回路 (Trieb): 命名——必须叫出名字，没名字的怪物最可怕。",
...

    {
        ...
        core: "A面：审讯驱力来自绝对确信——'你知道真相，且我有权知道'。极端情境下，这信念能碾压对方的沉默权，有时确实拯救了无辜。/ B面：但这可能一无所获——压力下人会说出你想听的。你得到的只是权力制造的回声。关键张力：如果确信他知道答案——你愿意走多远去得到它？道德底线在哪？ | 驱力回路 (Trieb): 逼问——必须知道，哪怕摧毁你。",
    ...
    },
    {
        ...
        core: "A面：窥视源于原始好奇——想看到未经编辑的真实。大家都展示精致的一面，你想看卸妆后的样子，这是理解人的起点。/ B面：但越界就成了侵犯——想看不等于'有权看'。他人的隐私不是你好奇的材料。关键张力：你想看真实的他们——如果那正是他们选择不展示的，窥视是理解还是侵犯？ | 驱力回路 (Trieb): 偷看——越禁止越非看不可。",
    ...
    },
    {
        ...
        core: "A面：解剖是认知的极致——不满足于'是什么'，你需要知道'怎么运作'。所有的理解始于把事物拆开。/ B面：但解剖完成的瞬间，活物也被杀死了。把一首诗拆成修辞，它就不再是诗。你理解了它，也毁了它。关键张力：理解和毁灭是同一个动作吗？必须打碎才能确切知晓？ | 驱力回路 (Trieb): 拆解——必须打开看，哪怕装不回去了。",
    ...
    },
    {
        ...
        core: "A面：去魅是最勇敢的穿透——拆掉维系安全感的幻象，露出背后冰冷的机制。必须先失去幻觉，才能获得真实。/ B面：但去魅后未必自由——有时幻象是别人赖以生存的唯一依靠。你拆了谎言，却没给什么替代品。关键张力：若真相让人崩溃，谎言让人活着——还应该把灯打开吗？ | 驱力回路 (Trieb): 祛魅——必须看到真相，哪怕魔法消失。",
    ...
    },
    {
        ...
        core: "A面：读心是极端的穿透——不满足于对方的话语，你要穿透到他自己都不知道的地方。从微表情和停顿拼凑出潜台词。/ B面：但读心极易被滥用——因为你读到的往往是你自己的投射。以为在理解对方，实则是用自己的框架填满他的沉默。关键张力：你'读'到的想法，有多少是你放进去的？ | 驱力回路 (Trieb): 透视——必须挖出沉默背后藏了什么。",
    ...
    },
    {
        ...
        core: "A面：灵魂拷问不是要答案——而是要暴露问题本身。'你为什么活着？'力量在于迫使你无法再假装问题不存在。/ B面：但这也是精神暴力——把人推向没准备好的深渊边缘。有些问题问出就无法收回。关键张力：你有多大权力用真相摧毁他？'帮他面对真相'与'真相谋杀'有多远？ | 驱力回路 (Trieb): 深问——问到眼泪流出，无处可躲。",
    ...
    },
    {
        ...
        core: "A面：诅咒是语言的穿甲弹——并非脏话，而是精准击中脆弱核心的宣判。'你永远不会被爱'，其致命在于说出了恐惧的真相。/ B面：但诅咒无法撤回——会在潜意识生根。你用一句话种下了永远无法停止生长的毒瘤。关键张力：你说出是因为那是现实，还是你想让它变成现实？ | 驱力回路 (Trieb): 诅咒——用一句话留下永久的敞口。",
