...
export const DRIVES_GROUP_A: LibraryItemDef[] = [
...

    {
        ...
        core: "A面：告白是勇气最纯粹的形态——你把最脆弱的部分暴露在所有人面前，赌注不是胜利，而是'我活得真实'。/ B面：但说出口的那一秒你就失去了撤回的权利。沉默时你还能假装感情不存在——说出来之后，空气永远变了。关键张力：你说出真相是为了改变什么，还是因为继续沉默比开口更痛苦？ | 驱力回路 (Trieb): 坦白——必须让压在胸口的东西离开身体。",
    ...
    },
    {
        ...
        core: "A面：大多数伟大的发现和改革，最初都被视为疯狂。你的坚持也许正在等待一个尚未诞生的听众。/ B面：但'逆流'不等于'正确'——绝大多数逆流者确实是错的。在答案揭晓之前，先驱和偏执狂在外表上完全一样。关键张力：所有人都说你错了——你凭什么相信自己对的？凭理性，还是一种你不愿承认的自恋？ | 驱力回路 (Trieb): 执拗——无论代价，我要按自己看到的真相走路。",
    ...
    },
    {
        ...
        core: "A面：孤注一掷是对生命最激烈的投入——你拒绝安全的平庸，选择危险的可能。把一切押上去的人活出了大多数人想活但不敢活的样子。/ B面：但'不留退路'往往是自我催眠——你逼自己到绝境，不是因为确信会赢，而是害怕在安全中慢慢腐烂。关键张力：你是真的在追求目标，还是在用'全力以赴'来逃避'万一白活了'的恐惧？ | 驱力回路 (Trieb): 赌注——要么拥有一切，要么确认自己至少敢赌。",
    ...
    },
    {
        ...
        core: "A面：据理力争是文明的纠错机制——当所有人沉默时一个人站出来说'不对'，他替整个群体保住了最后的尊严。/ B面：但坚持的代价不是壮烈——而是漫长的、无人喝彩的消耗。你说了一百次'不对'没人听，你还要说第一百零一次吗？关键张力：你是在维护真理，还是在维护'我不可能错'的自尊？两者的外在表现完全一样。 | 驱力回路 (Trieb): 坚守——'我知道这是对的'的不可动摇。",
    ...
    },
    {
        ...
        core: "A面：死磕是天赋之外唯一可靠的力量——第一万次练习和第一次一样认真，这种愚笨的坚持本身就是最稀有的才华。/ B面：但死磕也是认知陷阱——你用劳动量代替思考。也许换一条路才对，但你害怕承认之前的一万次全白费了。关键张力：你的坚持是智慧还是沉没成本的囚徒？两者给你的感受完全一样。 | 驱力回路 (Trieb): 磨损——用时间和重复打磨一切不肯让步的障碍。",
    ...
    },
    {
        ...
        core: "A面：他们说'你不属于这里'，你说'我已经在这里了'。每一个打破壁垒的先驱者都是推门而入的人，你的在场本身就是宣言。/ B面：但进了门之后门里的人并不欢迎你。你赢得了准入权，但永远是'那个闯进来的人'。关键张力：你花全部力气进入这个房间——进来后发现并不想待在这里。推门是为了门里面的东西，还是为了推门本身？ | 驱力回路 (Trieb): 闯入——既然没有邀请函，我就自己写一张。",
    ...
    },
    {
        ...
        core: "A面：承受羞辱而不倒下是最安静的力量——在所有人等着看你崩溃的时刻拒绝崩溃。这种沉默的挺立比任何反击都更让施辱者不安。/ B面：但'承受'和'麻木'的边界极其模糊——你以为你在坚忍，也许你早已失去了感受痛苦的能力。你不是在抵抗，你只是坏了。关键张力：你站在那里不动——是出于力量，还是出于无处可去？ | 驱力回路 (Trieb): 挺立——把身体变成一面沉默的拒绝之墙。",
...

    {
        ...
        core: "A面：你看到了所有人习以为常的世界中被忽略的裂缝，并且有勇气说出来。每一次颠覆都让人类更接近真实。/ B面：但颠覆者和偏执狂难以区分——答案被证实之前，'天才的洞见'和'疯子的胡话'外表完全一样。关键张力：你确信自己发现了真理——但这种确信让你和每个被证伪的妄想者一模一样。什么能区分你们？只有时间。 | 驱力回路 (Trieb): 颠覆——推翻已知世界的地基，看看下面到底是什么。",
    ...
    },
    {
        ...
        core: "A面：所有伟大的艺术都曾被同代人视为冒犯。禁忌标记了文化最害怕面对的真相，艺术的职责恰恰是把手伸进那个缝隙里。/ B面：但'冒犯'不等于'深刻'——很多作品只是用'脏'替代了'深'。你以为在揭露真相，也许只是消费他人的痛苦来获取注意力。关键张力：你创造这件作品是因为有必须被说出的真理，还是享受'被禁止'这个标签的刺激？ | 驱力回路 (Trieb): 冒犯——必须触碰那条线，因为线的存在本身就是对真相的压制。",
    ...
    },
    {
        ...
        core: "A面：规则说'不行'，良知说'必须'。那些违反命令折返救人的人不是英雄主义者，他们只是无法做到不回头。这种冲动恰恰是人之所以为人的证据。/ B面：但违规拯救也是危险的自恋——你把自己放在规则之上。系统存在的理由恰恰是因为个人判断不可靠。关键张力：你的善举之所以像善举，仅仅因为你恰好是对的。如果人人都越权行事，世界更好还是更糟？ | 驱力回路 (Trieb): 良知——当规则和人性相撞，选择站在人性一边。",
    ...
    },
    {
        ...
        core: "A面：叛教是最诚实的精神手术——你切开从小被灌注的一切，逐一检视，发现有些已经腐烂。你为了灵魂的真实而放弃了归属感。/ B面：但叛教者往往从一套教条跳入另一套——你离开了父亲的信仰，加入了某个'觉醒'群体。你只是换了一个主人。关键张力：你是真的独立思考了，还是选择了一个更时髦的牢笼？ | 驱力回路 (Trieb): 背弃——为了成为自己，必须先亲手杀死童年的你。",
    ...
    },
    {
        ...
        core: "A面：第一个举旗的人最孤独也最被记住——不知道身后有没有人跟上，但先站了起来。每一场革命都始于一个人的声音。/ B面：但领袖和煽动者的区别很微妙——你是因为看到不公才站出来，还是需要从'领导别人'中获得存在感？关键张力：如果成功了，你能放下旗帜回到普通人中吗？还是旗帜已经长进了你的手里？ | 驱力回路 (Trieb): 号召——必须把个人的'不'放大为所有人的'不'。",
    ...
    },
    {
        ...
        core: "A面：破例者重新定义了可能性的天花板——在他们之后，同样的事变得平凡。他们撕开的不是物理极限，而是想象力的极限。/ B面：但'第一个'的执念也可能是虚荣——你追求的是成就本身，还是'第一个'这个头衔？如果有人比你早了一天，你的努力就失去价值了吗？关键张力：你打破的是世界的限制，还是你对自己'不够特别'的恐惧？ | 驱力回路 (Trieb): 开拓——在'不可能'的地图上标注第一个脚印。",
...

    {
        ...
        core: "A面：有些门只有用身体去撞才会开。在极端压迫下，物理性的爆发本身就是一种否定：'我不接受这个处境。'/ B面：但暴力的逻辑是自毁的——撞碎墙壁的同时拳头也碎了。你赢了出口，但已经不是走进来的那个人。关键张力：如果杀出血路的代价是变成你曾经最厌恶的暴徒——这条路还值得走吗？ | 驱力回路 (Trieb): 毁灭——撞碎一切的冲动本身成为唯一的确定性。",
    ...
    },
    {
        ...
        core: "A面：你知道你会倒下，但你选择用倒下的方式证明你站过。恐惧消失了，因为最坏的结果已经被接受。这不是疯狂，是极端的清醒。/ B面：但冲锋的壮烈往往掩盖了更冷酷的事实——你冲锋不是因为勇敢，而是因为没有别的选择。英雄主义有时只是绝望的另一个名字。关键张力：你冲向终点是为了赢得什么，还是因为活着已经比倒下更不可忍受？ | 驱力回路 (Trieb): 冲动——'唯一能赢的方式就是不再想活下来'。",
    ...
    },
    {
        ...
        core: "A面：'这是我的东西，我有权决定它的命运，哪怕是灰烬。'在无路可退时，毁灭自己的一切反而成为唯一的自由。/ B面：但焦土之后是空无。你让对手一无所获——但你自己也一无所有了。你赢了一场没有奖品的战争。关键张力：如果你只能通过毁灭来证明拥有——你到底拥有过吗？ | 驱力回路 (Trieb): 否定——'我的最后自由是毁灭我自己的一切'。",
    ...
    },
    {
        ...
        core: "A面：复仇是原始的正义——当法律无力惩罚施害者，受害者自己成为法官和刽子手。世界被打破了，必须有人用相同的力度打回来。/ B面：但复仇的最深陷阱是——完成之后什么都没变。你击倒了他，但伤疤没有因此愈合。复仇给你的不是满足，是更深的空洞。关键张力：如果复仇过程中你变成了比仇人更残忍的人——你是在讨公道，还是在享受暴力本身？ | 驱力回路 (Trieb): 偿还——一笔永远算不清的账，因为伤害不可量化。",
    ...
    },
    {
        ...
        core: "A面：你终于说出了压在胸口十年的话，虽然那些话会炸毁一切。有些关系只有被打碎，双方才能开始真正生长。沉默的维系比爆发的分裂更有毒。/ B面：但决裂是不可逆的——你可以道歉，但无法收回说出口的话。它们嵌入对方的记忆，永远。关键张力：为什么大多数人宁愿选择虚假的和平？因为沉默比真相更舒服。 | 驱力回路 (Trieb): 断裂——宁愿把一切炸成碎片，也不能再假装完好。",
    ...
    },
    {
        ...
        core: "A面：围困是冲撞的耐心形式——不需要比对方更强，只需要更能等。用饥饿和绝望代替刀剑，是最经济也最残酷的胜利方式。/ B面：但围困者也被围困着——为了困住对方，你必须把自己也钉在城墙外面。时间吃掉了双方。关键张力：如果围城的代价是你也变成城墙的一部分——你是征服者还是另一个囚徒？ | 驱力回路 (Trieb): 封锁——'时间会吃掉他们，不用我动手'。",
    ...
    },
    {
        ...
        core: "A面：你也许打不赢他，但你可以确保他的胜利毫无意义。在极端力量悬殊中，'一起倒下'是弱者唯一可以触及的公平。逻辑不是胜利，是拒绝独自承受失败。/ B面：但同归于尽严格来说不是对抗——它是放弃。你放弃了活下来打赢他的可能，只选择了最低限度的胜利：让他也输。关键张力：'我的毁灭是通向真理的门票'——但如果门票只通向虚无，你买它是为了真理还是为了不再承受活着的重量？ | 驱力回路 (Trieb): 殉爆——用自己的终结确保对方也无法继续。",
